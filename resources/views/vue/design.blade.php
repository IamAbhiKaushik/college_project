...
<head>
	...
	<title>{{$exam->test_name}} | Hosted by {{session('coachingName')}}</title>
	...
	<style>
		...
		.question{
			...
			min-height: 20vh;overflow-x: hidden;overflow-y: scroll;padding: 1px;margin: 1px;
		}
		.sideSection{
			margin: 0;padding: 4px;overflow: auto;width: 100%;
			min-height: 20vh;max-height: 50.5vh;
		}
		.introOne{
			width: 50%;text-align: center;padding: 30px;border:1px solid #bdbdbd;float: left;
		}
		.introTwo{
			width: 50%;float: right;
		}
		.examBtn{cursor:pointer;border:1px solid #bdbdbd;margin:0 0 0 10px;padding:6px 16px;font-size:24px;}
		#ansBox1{font-size: 24px;}
		#ansBox2{font-size: 24px;}
		#ansBox3{font-size: 24px;}
		.version{border:1px solid #617B8C;background: #617B8C;color: white;padding: 0px;text-align: center;}
		...
		@media (min-width: 62em) {
			...
			.examBtn{margin:0 0 0 10px;padding:6px 16px;font-size:110%}
			#ansBox1{font-size: 100%;}
			#ansBox2{font-size: 100%;}
			#ansBox3{font-size: 100%;}
			.version{font-size: 70%;}
			.heading{
				font-size: 28px;
			}
		}
...
<body style="margin: 0;font-weight: 600" onload="showPDF('/student/pdf/{{$exam->exam_code}}')">
{{--<div style="width: 100%;padding-bottom: 5px;padding-top: 5px;background: #2d70b8;color: white;">--}}
	{{--<div class="row" style="margin-right: 0;margin-left: 0;">--}}
		{{--<div class="col-xs-6 col-sm-4">	<h4 style="text-transform: capitalize;">{{$exam->test_name}}</h4></div>--}}
		{{--<div class="col-sm-4"></div>--}}
        {{--<div class="col-xs-6 col-sm-4">--}}
			{{--<h4 class="mobi" style="text-align: right;  text-transform: capitalize;">{{session('coachingName')}}</h4></div>--}}
        {{--</div>--}}
		{{--</div>--}}
	{{--</div>--}}
{{--</div>--}}
...
<div class="heading">
	{{$exam->test_name}}<i style="font-size: 80%"> | {{session('coachingName')}}</i>
</div>

<ul class="info">
	<li><a id="connection-check" href="#" style="background: green;color: white;border-left: 1px solid white;border-right: 1px solid white;">Connected</a></li>
...
<div class="row" style="margin: 0" id="root">
    ...
    padding-left: 10px;">
			...
			<button class="btn mobi" style="background: #38a9eb;margin: 6px;border-radius: 5px;color: white; ">Question Paper (Section Wise)</button>
		</div>


		{{--<div style="background: #4e85c5;--}}
    {{--padding-left: 10px;">--}}
			{{--<button class="btn" style="font-size: 90%;background: #38a9eb;margin: 6px;border-radius: 5px;color: white; " onclick="openFullscreen()">Enter Full Screen</button>--}}
		{{--</div>--}}

		
		<div style="padding: 5px;width: 100%;border: 2px solid white">
			<p class="mobi" style="float: left;margin: 0;">Sections</p>
			<p id="timer" class="mobi" style="float: right;"> Time Left: <i id="minute">{{$exam->duration*60}}</i>:<i id="sec0">0</i><i id="sec1">0</i>
			<!-- <p style="float: right;margin: 0;">Time Clock</p> -->
		</div>
<br>
<!-- question_btn('.$kn_btn->question_number.') -->
		<ul class="nav sections mobi" style="font-size: 110%;border-top: 1px solid #bdbdbd">
		...
		<div class="question">
			...
			<div id="pdf-main-container">
			    <div id="pdf-loader">Loading your Examination, Please wait ...</div>
			    <div id="pdf-contents" >
			        <!-- <div id="pdf-meta">
			            <div id="pdf-buttons">
		...
		<div style="width: 100%;border:1px solid #bdbdbd;padding: 0px;">
			<div class="row" style="padding: 0;margin: 0;">
				<div class="col-sm-9" style="padding: 8px;margin: 0;">
				...
				<div class="col-sm-3" style="padding: 8px;margin: 0;">
	...
	<div class="col-lg-3 marked">
		<div class="introOne">{{$user->name}} | {{session('username')}}<br>
			{{$user->coaching_rollno}} | {{$user->coaching_batch}}
			<br>
		</div>
		<div style="border:1px solid black;">
			<div class="introTwo" style="font-size: 90%;padding: 4px;margin: 0">
...
<br>
				{{--<p> To Submit a question for evalutaion, make sure you click save and next or Mark for review.</p>--}}
			</div>
		</div>
		<div style="width: 100%;padding: 6px;margin: 0;">
			<form action='/submitExam/{{$exam->id}}' method="POST" id="responseForm">
				{!! csrf_field() !!}
				...
				<div style="width:100%;padding: auto;text-align: center;">
					<label class="examBtn" style="background-color: #0c7cd5;color: white;padding: 10px 26px;" v-on:click="submit()">Submit</label>
					<!-- <div style="border: 1px solid #bdbdbd;">Clear Response</div> -->
				</div>
			</form>
			</div>
