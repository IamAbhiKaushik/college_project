...
<html>
<head>
    <title>{{$exam->test_name}} | Hosted by {{Auth::user()->coachingName}}</title>
    ...
    <style>
        ...
        .sideSection{
            margin: 0;padding: 4px;min-height: 15vh;max-height: 50.5vh;overflow: auto
        }
...
<body style="margin: 0;font-weight: 600" onload="showPDF('/files/{{$exam->pdf}}.pdf')" id="body">
<div style="width: 100%;padding-bottom: 5px;padding-top: 5px;background: #2d70b8;color: white;">
    <div class="row" style="margin-right: 0;margin-left: 0;">
        ...
        <div class="col-sm-4">
            <h4 style="text-align: right">{{Auth::user()->coachingName}}</h4></div>
    </div>
</div>
</div>
</div>
...
<div class="row" style="margin: 0" id="root">
    ...
    padding-left: 10px;">
            <button class="btn" style="font-size: 90%;background: #38a9eb;margin: 6px;border-radius: 5px;color: white; " onclick="openFullscreen()">Question Paper (Section Wise)</button>
        </div>
        ...
        <div class="question" >
            ...
            <div id="pdf-main-container">
                ...
                <div id="pdf-contents">
                    ...
                    <canvas id="pdf-canvas" width="950"></canvas>
        ...
        <div style="width: 100%;border:1px solid #bdbdbd;padding: 0px;">
            <div class="row" style="padding: 0;margin: 0;">
                ...
                <div class="col-sm-3" style="padding: 8px;margin: 0;">
                    <label class="examBtn" style="background-color: #0c7cd5;color: white;float: right" onclick="save()">Save And Next</label>
    ...
    <div class="col-lg-3 marked">
        <div style="width: 100%;text-align: center;padding: 30px;border:1px solid #bdbdbd; ">User | Test User<br>
            180100123 | {{Auth::user()->coachingName}}
            <br>
        </div>
...
<div style="border:1px solid #617B8C;background: #617B8C;color: white;padding: 0px;font-size:80%;text-align: center;">
    Version : 3.3.0 | SmrtBook.in
...
// gettingfull();
    ...
    $(elem).on ('mozfullscreenchange webkitfullscreenchange fullscreenchange',function(){
        // this.fullScreenMode = !this.fullScreenMode;

        if(window.innerHeight != screen.height) {
            // browser is fullscreen
            // alert("Window not in full screen");
            var tt = confirm("Go to full screen Mode, Press Yes");
            if (tt == true) {
                openFullscreen
            } else {
                gettingfull()
