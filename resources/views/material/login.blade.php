    ...
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            {{--<form class="login100-form validate-form">--}}
                <form class="login100-form validate-form" action="/student/dashboard" method="POST">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                    <input class="input100" type="text" name="username" placeholder="Username or Registered email id" required>
                ...
                <div class="text-center p-t-136">
                    <a class="txt2" href="/student/register">
                        Not Yet Registered with <b class="host">..</b>, Register Now
