...
<div class="limiter">
    ...
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="/student/register/{{$coaching->user_key}}" method="POST">
                {!! csrf_field() !!}
                <span class="login100-form-title">
						Student Register
					</span>
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid Roll NO is required">
                    <input class="input100" type="text" name="rollno" required placeholder="Your Roll No">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
                    <select type="text" class="input100" name="coaching">
                        <option value="{{$coaching->user_name}}">{{$coaching->coachingName}}</option>
                    </select>
                    {{--<input class="input100" type="email" name="emailid" required placeholder="Email ID">--}}
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
