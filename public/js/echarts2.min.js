...
! function(t) {
    ...
    function i(t, e) {
        ...
        var n = [];
        if ("string" == typeof t ? i(t) : C(t, function(t) {
            i(t)
        }), n.length > 0) throw new Error("[REQUIRE_FATAL]Relative ID is not allowed in global require: " + n.join(", "));
        var r = R.waitSeconds;
        return r && t instanceof Array && (w && clearTimeout(w), w = setTimeout(o, 1e3 * r)), D(t, e)
    }

    function o() {
        function t(s, a) {
            if (!r[s] && !d(s, O)) {
                r[s] = 1, d(s, k) || o[s] || (o[s] = 1, e.push(s));
                var h = L[s];
                h ? a && (o[s] || (o[s] = 1, e.push(s)), C(h.depMs, function(e) {
                    t(e.absId, e.hard)
                })) : n[s] || (n[s] = 1, i.push(s))
            }
        }
            ...
            if (!t && document.attachEvent && (!o || "[object Opera]" !== o.toString())) {
                var n = function() {
                    ...
                    for (var t = document.getElementsByTagName("script"), e = t.length; e--;) {
                        var i = t[e];
                        if ("interactive" === i.readyState) return X = i, i
                    }
                }();
    ...
    function h(e) {
        ...
        if (i && !d(e, M)) {
            var o = i.deps,
                n = i.factory,
                r = 0;
            "function" == typeof n && (r = Math.min(n.length, o.length), !i.depsDec && n.toString().replace(/(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/gm, "").replace(/require\(\s*(['"'])([^'"]+)\1\s*\)/g, function(t, e, i) {
                o.push(i)
            }));
            var s = [],
                a = [];
            C(o, function(t, o) {
                ...
                c && !I[c] ? (l.res && (h = {
                    ...
                    mod: c,
                    res: l.res
                }, a.push(t), i.depRs.push(h)), (n = i.depMkv[c]) || (n = {
                    id: l.mod,
                    absId: c,
                    hard: r > o
                }, i.depMs.push(n), i.depMkv[c] = n, s.push(c))) : n = {
                    absId: c
                }, r > o && i.factoryDeps.push(h || n)
            }), i.state = M,
                function(e) {
                    var i, o = L[e];
                    o.invokeFactory = function() {
                        if (!i && o.state === k) {
                            i = 1;
                            var n = 1;
                            if (C(o.factoryDeps, function(t) {
                                var e = t.absId;
                                return I[e] ? void 0 : (u(e), n = d(e, O))
                            }), n) {
                                try {
                                    var r = o.factory,
                                        s = "function" == typeof r ? r.apply(t, p(o.factoryDeps, {
                                            require: o.require,
                                            exports: o.exports,
                                            module: o
                                        })) : r;
                                    ...
                                    if (/^\[MODULE_MISS\]"([^"]+)/.test(t.message)) {
                                        var a = o.depMkv[RegExp.$1];
                ...
                }(e), g(s), a.length && i.require(a, function() {
                C(i.depRs, function(t) {
                    t.absId || (t.absId = T(t.id, e))
                }), l()
            })
        }
    }
    ...
    function l() {
        for (var t in P) h(t), c(t), u(t)
    }

    function c(t) {
        var e = {};
        ! function t(i) {
            if (h(i), !d(i, M)) return !1;
            if (d(i, k) || e[i]) return !0;
            e[i] = 1;
            var o = L[i],
                n = !0;
            return C(o.depMs, function(e) {
                return n = t(e.absId)
            }), n && C(o.depRs, function(t) {
                return n = !!t.absId
            }), n && (o.state = k), n
        }(t)
    }
    ...
    function p(t, e) {
        ...
        return C(t, function(t, o) {
            "object" == typeof t && (t = t.absId), i[o] = e[t] || L[t].exports
        }), i
    }

    function f(t) {
        L[t].state = O, delete P[t];
        for (var e = F[t] || [], i = e.length; i--;) e[i]();
        e.length = 0, F[t] = null
    }
    ...
    function g(e, i, o) {
        function r() {
            if ("function" == typeof i && !a) {
                var o = 1;
                C(e, function(t) {
                    return I[t] ? void 0 : o = !!d(t, O)
                }), o && (a = 1, i.apply(t, p(e, I)))
            }
        }
        var a = 0;
        C(e, function(t) {
            I[t] || d(t, O) || (function(t, e) {
                if (d(t, O)) e();
                else {
                    var i = F[t];
                    i || (i = F[t] = []), i.push(e)
                }
            }(t, r), (t.indexOf("!") > 0 ? function(t, e) {
                function i(e) {
                    a.exports = e || !0, f(t)
                }
                if (!L[t]) {
                    var o = q[t];
                    if (o) return void m(o);
                    var r = S(t),
                        a = {
                            id: t,
                            state: M
                        };
                    L[t] = a, i.fromText = function(t, e) {
                        new Function(e)(), n(t)
                    }, h = D(r.mod), l = e ? L[e].require : D, h.load(r.res, l, i, s.call({
                        id: t
                    }))
                }
                var h, l
    ...
    function m(e) {
        function i() {
            ! function(t, e) {
                function i() {
                    var t = o.readyState;
                    (void 0 === t || /^(loaded|complete)$/.test(t)) && (o.onload = o.onreadystatechange = null, o = null, e())
                }
                var o = document.createElement("script");
                o.setAttribute("data-require-id", t), o.src = x(t + ".js"), o.async = !0, o.readyState ? o.onreadystatechange = i : o.onload = i, Z = o, U ? V.insertBefore(o, U) : V.appendChild(o), Z = null
            }(q[e] || e, o)
        }

        function o() {
            var i;
            s ? ("function" == typeof s.init && (i = s.init.apply(t, p(a, I))), null == i && s.exports && (i = t, C(s.exports.split("."), function(t) {
                return !!(i = i[t])
            })), r(e, a, i || {})) : n(e);
            l()
        }
    ...
    function y() {
        ...
        R.baseUrl = R.baseUrl.replace(/\/$/, "") + "/", N = _(R.paths), C(W = _(R.map, 1), function(t) {
            t.v = _(t.v)
        }), Y = [], C(R.packages, function(t) {
            var e = t;
            "string" == typeof t && (e = {
                name: t.split("/")[0],
                location: t,
                main: "main"
            }), e.location = e.location || e.name, e.main = (e.main || "main").replace(/\.js$/i, ""), e.reg = z(e.name), Y.push(e)
        }), Y.sort(E), G = _(R.urlArgs, 1), q = {};
        for (var e in R.bundles) C(R.bundles[e], t)
    }
    ...
    function x(t) {
        ...
        var s, a = n;
        return v(n, N, function(t, e) {
            a = a.replace(e, t), s = 1
        }), s || v(n, Y, function(t, e, i) {
            a = a.replace(i.name, i.location)
        }), /^([a-z]{2,10}:\/)?\//i.test(a) || (a = R.baseUrl + a), a += o + r, v(n, G, function(t) {
            a += (a.indexOf("?") > 0 ? "&" : "?") + t
        }), a
    }
    ...
    function b(t) {
        function i(i, n) {
            if ("string" == typeof i) {
                if (!o[i]) {
                    var r = T(i, t);
                    if (u(r), !d(r, O)) throw new Error('[MODULE_MISS]"' + r + '" is not exists!');
                    o[i] = L[r].exports
                }
                return o[i]
            }
            if (i instanceof Array) {
                ...
                C(i, function(i, o) {
                    ...
                    if (h) {
                        var c = r + "!" + h;
                        0 !== h.indexOf(".") && q[c] ? r = l = c : l = null
                    }
                    a[o] = l, e(r), s.push(r)
                }), g(s, function() {
                    C(a, function(o, n) {
                        null == o && e(o = a[n] = T(i[n], t))
                    }), g(a, n, t), l()
                }, t), l()
            }
        }
        ...
        if (t) {
            for (var e in R) {
                var i = t[e],
                    o = R[e];
                if (i)
                    if ("urlArgs" === e && "string" == typeof i) R.urlArgs["*"] = i;
    ...
    var N, Y, W, q, G, Z, X, V = document.getElementsByTagName("head")[0],
        U = document.getElementsByTagName("base")[0];
    U && (V = U.parentNode), define || (define = r, require || (require = i), esl = i)
    ...
    a.version = "2.2.7", a.dependencies = {
        ...
        var n = t("zrender");
        n.version.replace(".", "") - 0 < a.dependencies.zrender.replace(".", "") - 0 && console.error("ZRender " + n.version + " is too old for ECharts " + a.version + ". Current version need ZRender " + a.dependencies.zrender + "+");
        var r = (e = e instanceof Array ? e[0] : e).getAttribute(d);
    ...
    return i.prototype = {
        _init: function() {
            ...
            this._zr = i, this._messageCenter.dispatch = function(t, i, o, n) {
                (o = o || {}).type = t, o.event = i, e._messageCenter.dispatchWithContext(t, o, n), e._messageCenterOutSide.dispatchWithContext(t, o, n)
            ...
            var f = t("./component");
            f.define("title", t("./component/title")), f.define("tooltip", t("./component/tooltip")), f.define("legend", t("./component/legend")), (0 === i.getWidth() || 0 === i.getHeight()) && console.error("Domâ€™s width & height should be ready before init.")
        },
        __onevent: function(t) {
            ...
            switch (this._curEventType || (this._curEventType = t.type), t.type) {
                ...
                case n.EVENT.TOOLTIP_OUT_GRID:
                    var r;
                    if (e) {
                        if (this._connected)(r = this.component.grid) && (t.x = (t.event.zrenderX - r.getX()) / r.getWidth(), t.y = (t.event.zrenderY - r.getY()) / r.getHeight())
                    } else(r = this.component.grid) && this._zr.trigger("mousemove", {
                        connectTrigger: !0,
        ...
        _render: function(e) {
            if (this._mergeGlobalConifg(e), !this._noDataCheck(e)) {
                ...
                e.renderAsImage && h ? (v ? v.src = this.getDataURL(e.renderAsImage) : ((v = this.getImage(e.renderAsImage)).id = y, v.style.position = "absolute", v.style.left = 0, v.style.top = 0, this.dom.firstChild.appendChild(v)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : v && v.parentNode.removeChild(v), v = null, this._option = e
            }
        },
        restore: function() {
        ...
        _mergeGlobalConifg: function(e) {
            ...
            s && s.length || (s = this._themeConfig.color || n.color), this._zr.getColor = function(e) {
                return t("zrender/tool/color").getColor(e, s)
            ...
            function t(t) {
                ...
                if (o)
                    if (o instanceof Array)
                        for (var n = o.length; n--;) e[t][n].data = r.clone(o[n].data);
        ...
        _setTimelineOption: function(e) {
            ...
            var i = new(t("./component/timeline"))(this._themeConfig, this._messageCenter, this._zr, e, this);
            return this._timeline = i, this.component.timeline = this._timeline, this
        },
        addData: function(t, e, i, o, s) {
            function a() {
                if (d._zr) {
                    ...
                    d._messageCenter.dispatch(n.EVENT.REFRESH, null, {
                        option: l
                    }, d)
                }
            }
            for (var h = t instanceof Array ? t : [
                ...
                if (f) {
                    var _, y, v = f.data,
                        x = l.series[t].data;
                    if (v[g](e), x[g](e), o || (v[m](), e = x[m]()), null != s)
                        if (f.type === n.CHART_TYPE_PIE && (_ = c.legend) && (y = _.data)) {
                            var b = l.legend.data;
                            if (y[g](s), b[g](s), !o) {
                                var T = r.indexOf(y, e.name); - 1 != T && y.splice(T, 1), -1 != (T = r.indexOf(b, e.name)) && b.splice(T, 1)
                            }
            ...
            var E = this._chartList,
                w = 0,
                L = function() {
                    0 === --w && a()
                };
            for (u = 0, p = E.length; p > u; u++) l.addDataAnimation && E[u].addDataAnimation && (w++, E[u].addDataAnimation(h, L));
        ...
        _addMark: function(t, e, i) {
            ...
            if (n && (o = n[t])) {
                var s = this._optionRestore.series[t],
                    a = o[i],
                    h = s[i];
                a = o[i] = a || {
                    data: []
                ...
                for (var l in e) "data" === l ? (a.data = a.data.concat(e.data), h.data = h.data.concat(e.data)) : "object" != typeof e[l] || null == a[l] ? a[l] = h[l] = e[l] : (r.merge(a[l], e[l], !0), r.merge(h[l], e[l], !0));
        ...
        getConnectedDataURL: function(e) {
            ...
            for (var h in o) c.addShape(new d({
                style: {
                    x: o[h].left - n,
                    y: o[h].top - r,
                    image: o[h].img
        ...
        setTheme: function(e) {
            ...
            if (!h) {
                ...
                i && i.fontFamily && i.fontFamily2 && (i.fontFamily = i.fontFamily2), (i = n.textStyle).fontFamily = i.fontFamily2
            }
    ...
    function i(t, i, n, r) {
        if (i.hasOwnProperty(n)) {
            var s = t[n];
            "object" != typeof s || l[c.call(s)] || e(s) ? !r && n in t || (t[n] = i[n]) : o(t[n], i[n], r)
        }
    }
    ...
    return {
        ...
        clone: function t(i) {
            if ("object" == typeof i && null !== i) {
                ...
                if (i instanceof Array) {
                    o = [];
                    for (var n = 0, r = i.length; r > n; n++) o[n] = t(i[n])
                } else if (!l[c.call(i)] && !e(i)) {
                    o = {};
                    for (var s in i) i.hasOwnProperty(s) && (o[s] = t(i[s]))
                }
                return o
            }
            return i
        ...
        getContext: function() {
            if (!n)
                if (t("../dep/excanvas"), window.G_vmlCanvasManager) {
                    ...
                    e.style.position = "absolute", e.style.top = "-1000px", document.body.appendChild(e), n = G_vmlCanvasManager.initElement(e).getContext("2d")
                } else n = document.createElement("canvas").getContext("2d");
            return n
        },
        ...
        each: function(t, e, i) {
            if (t && e)
                if (t.forEach && t.forEach === s) t.forEach(e, i);
        ...
        map: function(t, e, i) {
            if (t && e) {
                if (t.map && t.map === a) return t.map(e, i);
    ...
    "use strict";
    var e = t("../mixin/Eventful");
    return {
        getX: function(t) {
            return void 0 !== t.zrenderX && t.zrenderX || void 0 !== t.offsetX && t.offsetX || void 0 !== t.layerX && t.layerX || void 0 !== t.clientX && t.clientX
        },
        getY: function(t) {
            return void 0 !== t.zrenderY && t.zrenderY || void 0 !== t.offsetY && t.offsetY || void 0 !== t.layerY && t.layerY || void 0 !== t.clientY && t.clientY
        },
        getDelta: function(t) {
            return void 0 !== t.zrenderDelta && t.zrenderDelta || void 0 !== t.wheelDelta && t.wheelDelta || void 0 !== t.detail && -t.detail
        },
        stop: "function" == typeof window.addEventListener ? function(t) {
    ...
    var e = t("./tool/util"),
        ...
        l = {
            ...
            delInstance: function(t) {
                return delete h[t], l
            }
        },
        c = function(e, i) {
            var o;
            this.id = e, this.env = t("./tool/env"), this.storage = new s, this.painter = new r(i, this.storage), this.handler = new n(i, this.storage, this.painter), this.animation = new a({
                stage: {
                    update: (o = this, function() {
                        o._needsRefreshNextFrame && o.refresh()
                    })
                }
    ...
    return c.prototype.getId = function() {
    ...
    }, c.prototype.animate = function(t, o, n) {
        var r = this;
        if ("string" == typeof t && (t = this.storage.get(t)), t) {
            var s;
            if (o) {
                for (var a = o.split("."), h = t, l = 0, c = a.length; c > l; l++) h && (h = h[a[l]]);
                h && (s = h)
            } else s = t;
            if (!s) return void i('Property "' + o + '" is not existed in element ' + t.id);
            ...
            var d = t.__animators,
                u = this.animation.animate(s, {
                    ...
                    var i = e.indexOf(t.__animators, u);
                    i >= 0 && d.splice(i, 1)
                });
            return d.push(u), u
        }
        ...
        this.animation.stop(), this.clear(), this.storage.dispose(), this.painter.dispose(), this.handler.dispose(), this.animation = this.storage = this.painter = this.handler = null, l.delInstance(this.id)
    }, l
    ...
    function e(t, e, o, n, s) {
        ...
        h.shapeHandler.onmousewheel = function(t) {
            ...
            var n = r.get(e, "value"),
                s = n * h.option.island.calculateStep;
    ...
    return e.prototype = {
        ...
        _combine: function(e, i) {
            var o = t("zrender/tool/color"),
                n = t("../util/accMath").accAdd(r.get(e, "value"), r.get(i, "value")),
                s = r.get(e, "name") + this._nameConnector + r.get(i, "name");
            e.style.text = s + this._valueConnector + n, r.set(e, "value", n), r.set(e, "name", s), e.style.r = this.option.island.r, e.style.color = o.mix(e.style.color, i.style.color)
        },
        refresh: function(t) {
        ...
        add: function(t) {
            var e = r.get(t, "name"),
                i = r.get(t, "value"),
                n = null != r.get(t, "series") ? r.get(t, "series").name : "",
    ...
    return e.prototype = {
        ...
        _buildShape: function() {
            ...
            if (i.length > 0) {
                var s;
                for (n = 0, r = i.length; r > n; n++) s = i[n].name, o = i[n].key, this._iconList.push(s), this._featureTitle[s] = e[o].title[s] || e[o].title, e[o].icon && (this._featureIcon[s] = e[o].icon[s] || e[o].icon), e[o].color && (this._featureColor[s] = e[o].color[s] || e[o].color), e[o].option && (this._featureOption[s] = e[o].option[s] || e[o].option);
                this._itemGroupLocation = this._getItemGroupLocation(), this._buildBackground(), this._buildItem();
                for (n = 0, r = this.shapeList.length; r > n; n++) this.zr.addShape(this.shapeList[n]);
        ...
        _buildItem: function() {
            var e, i, o, r, a = this.option.toolbox,
        ...
        __onSaveAsImage: function() {
            var t, e = this.option.toolbox.feature.saveAsImage,
                i = e.type || "png";
            "png" != i && "jpeg" != i && (i = "png"), t = this.myChart.isConnected() ? this.myChart.getConnectedDataURL(i) : this.zr.toDataURL("image/" + i, this.option.backgroundColor && "rgba(0,0,0,0)" === this.option.backgroundColor.replace(" ", "") ? "#fff" : this.option.backgroundColor);
            ...
            n.href = t, n.setAttribute("download", (e.name ? e.name : this.option.title && (this.option.title.text || this.option.title.subtext) ? this.option.title.text || this.option.title.subtext : "ECharts") + "." + i), n.innerHTML = '<img style="vertical-align:middle" src="' + t + '" title="' + (window.ActiveXObject || "ActiveXObject" in window ? "å³é”®->å›¾ç‰‡å¦å­˜ä¸º" : e.lang ? e.lang[0] : "ç‚¹å‡»ä¿å­˜") + '"/>', o.appendChild(n), document.body.appendChild(o), n = null, o = null, setTimeout(function() {
        ...
        reset: function(t, e) {
            if (e && this.clear(), this.query(t, "toolbox.show") && this.query(t, "toolbox.feature.magicType.show")) {
                var i, o, n = t.toolbox.feature.magicType.type,
                    r = n.length;
                for (this._magicMap = {}; r--;) this._magicMap[n[r]] = !0;
                for (r = t.series.length; r--;) i = t.series[r].type, this._magicMap[i] && (o = t.xAxis instanceof Array ? t.xAxis[t.series[r].xAxisIndex || 0] : t.xAxis, o && "category" === (o.type || "category") && (o.__boundaryGap = null == o.boundaryGap || o.boundaryGap), o = t.yAxis instanceof Array ? t.yAxis[t.series[r].yAxisIndex || 0] : t.yAxis, o && "category" === o.type && (o.__boundaryGap = null == o.boundaryGap || o.boundaryGap), t.series[r].__type = i, t.series[r].__itemStyle = h.clone(t.series[r].itemStyle || {})), (this._magicMap[d] || this._magicMap[u]) && (t.series[r].__stack = t.series[r].stack)
            }
            ...
            if (a && a.show) {
                ...
                l > c && (l += c, l -= c = l - c), this._zoomQueue = [{
                    start: l,
                    end: c,
                    start2: 0,
                    end2: 100
        ...
        getMagicOption: function() {
            ...
            if (this._magicType[a.CHART_TYPE_LINE] || this._magicType[a.CHART_TYPE_BAR]) {
                for (var i = !this._magicType[a.CHART_TYPE_LINE], o = 0, n = this.option.series.length; n > o; o++) e = this.option.series[o].type, (e == a.CHART_TYPE_LINE || e == a.CHART_TYPE_BAR) && (t = this.option.xAxis instanceof Array ? this.option.xAxis[this.option.series[o].xAxisIndex || 0] : this.option.xAxis, t && "category" === (t.type || "category") && (t.boundaryGap = !!i || t.__boundaryGap), t = this.option.yAxis instanceof Array ? this.option.yAxis[this.option.series[o].yAxisIndex || 0] : this.option.yAxis, t && "category" === t.type && (t.boundaryGap = !!i || t.__boundaryGap));
            ...
            if (this._defaultMagic(a.CHART_TYPE_CHORD, a.CHART_TYPE_FORCE), this._defaultMagic(a.CHART_TYPE_PIE, a.CHART_TYPE_FUNNEL), this._magicType[d] || this._magicType[u])
                for (o = 0, n = this.option.series.length; n > o; o++) this._magicType[d] ? (this.option.series[o].stack = "_ECHARTS_STACK_KENER_2014_", e = d) : this._magicType[u] && (this.option.series[o].stack = null, e = u), this._featureOption[e + "Chart"] && h.merge(this.option.series[o], this._featureOption[e + "Chart"] || {}, !0);
            return this.option
        },
    ...
    return e.prototype = {
        ...
        _getItemGroupLocation: function() {
            var t, e = this.reformCssArray(this.titleOption.padding),
                ...
                s = Math.max(a.getTextWidth(i, n), a.getTextWidth(o, r)),
                h = a.getTextHeight(i, n) + ("" === o ? 0 : this.titleOption.itemGap + a.getTextHeight(o, r)),
                l = this.zr.getWidth();
    ...
    function e(t, e, r, s, a) {
        ...
        }, this.zr.on(h.EVENT.MOUSEMOVE, l._onmousemove), this.zr.on(h.EVENT.GLOBALOUT, l._onglobalout), l._hide = function(t) {
            return l.__hide(t)
    ...
    var i = t("./base"),
        ...
        r = new(t("zrender/shape/Rectangle"))({}),
        s = t("../config");
    s.tooltip = {
        zlevel: 1,
        z: 8,
    ...
    return e.prototype = {
        ...
        _style: function(t) {
            ...
            var n = t.padding;
            return null != n && (n = this.reformCssArray(n), e.push("padding:" + n[0] + "px " + n[1] + "px " + n[2] + "px " + n[3] + "px")), e.join(";") + ";"
        },
        __hide: function() {
        ...
        _show: function(t, e, i, o) {
            ...
            t && ("function" == typeof t && (t = t([e, i])), t instanceof Array && (e = t[0], i = t[1])), e + r > this._zrWidth && (e -= r + 40), i + n > this._zrHeight && (i -= n - 20), 20 > i && (i = 0), this._tDom.style.cssText = this._gCssText + this._defaultCssText + (o || "") + "left:" + e + "px;top:" + i + "px;", (10 > n || 10 > r) && setTimeout(this._refixed, 20), this.showing = !0
        },
        __refixed: function() {
            if (this._tDom) {
                var t = "",
        ...
        __tryShow: function() {
            ...
            if (this._curTarget) {
                ...
                var e = a.get(this._curTarget, "series"),
                    i = a.get(this._curTarget, "data");
                t = this.deepQuery([i, e, this.option], "tooltip.show"), null != e && null != i && t ? "axis" === this.deepQuery([i, e, this.option], "tooltip.trigger") ? this._showAxisTrigger(e.xAxisIndex, e.yAxisIndex, a.get(this._curTarget, "dataIndex")) : this._showItemTrigger() : (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), this._hidingTicket = setTimeout(this._hide, this._hideDelay))
            } else this._findPolarTrigger() || this._findAxisTrigger()
        },
        _findAxisTrigger: function() {
            if (this.component.xAxis && this.component.yAxis) {
                for (var t, e, i = this.option.series, o = 0, n = i.length; n > o; o++)
                    if ("axis" === this.deepQuery([i[o], this.option], "tooltip.trigger")) return t = i[o].xAxisIndex || 0, e = i[o].yAxisIndex || 0, this.component.xAxis.getAxis(t) && this.component.xAxis.getAxis(t).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? void this._showAxisTrigger(t, e, this._getNearestDataIndex("x", this.component.xAxis.getAxis(t))) : this.component.yAxis.getAxis(e) && this.component.yAxis.getAxis(e).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? void this._showAxisTrigger(t, e, this._getNearestDataIndex("y", this.component.yAxis.getAxis(e))) : void this._showAxisTrigger(t, e, -1);
        ...
        _findPolarTrigger: function() {
            ...
            var t, e = l.getX(this._event),
                i = l.getY(this._event),
                o = this.component.polar.getNearestIndex([e, i]);
            return o ? (t = o.valueIndex, o = o.polarIndex) : o = -1, -1 != o && this._showPolarTrigger(o, t)
        },
        _getNearestDataIndex: function(t, e) {
            var i = -1,
                o = l.getX(this._event),
                n = l.getY(this._event);
            if ("x" === t) {
            ...
            var c, d, u = this.component.grid.getY();
            for (h = e.getCoordByIndex(i); h > u && (c = h, h >= n);) d = h, h = e.getCoordByIndex(++i);
            return 0 >= i ? i = 0 : n - c >= d - n ? i -= 1 : null == e.getNameByIndex(i) && (i -= 1), i
        },
        _showAxisTrigger: function(t, e, i) {
            if (!this._event.connectTrigger && this.messageCenter.dispatch(s.EVENT.TOOLTIP_IN_GRID, this._event, null, this.myChart), null == this.component.xAxis || null == this.component.yAxis || null == t || null == e) return clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), void(this._hidingTicket = setTimeout(this._hide, this._hideDelay));
            var o, n, r, a, h = this.option.series,
                c = [],
                d = [],
                u = "";
            ...
            var p, f, g = -1 != t && this.component.xAxis.getAxis(t).type === s.COMPONENT_TYPE_AXIS_CATEGORY ? "xAxis" : -1 != e && this.component.yAxis.getAxis(e).type === s.COMPONENT_TYPE_AXIS_CATEGORY && "yAxis";
            if (g) {
                var m, _ = "xAxis" == g ? t : e;
                o = this.component[g].getAxis(_);
                for (var y = 0, v = h.length; v > y; y++) this._isSelected(h[y].name) && h[y][g + "Index"] === _ && "axis" === this.deepQuery([h[y], this.option], "tooltip.trigger") && (a = this.query(h[y], "tooltip.showContent") || a, n = this.query(h[y], "tooltip.formatter") || n, r = this.query(h[y], "tooltip.position") || r, u += this._style(this.query(h[y], "tooltip")), null != h[y].stack && "xAxis" == g ? (c.unshift(h[y]), d.unshift(y)) : (c.push(h[y]), d.push(y)));
                this.messageCenter.dispatch(s.EVENT.TOOLTIP_HOVER, this._event, {
                    seriesIndex: d,
                    dataIndex: i
                }, this.myChart), "xAxis" == g ? (p = this.subPixelOptimize(o.getCoordByIndex(i), this._axisLineWidth), f = l.getY(this._event), m = [p, this.component.grid.getY(), p, this.component.grid.getYend()]) : (p = l.getX(this._event), f = this.subPixelOptimize(o.getCoordByIndex(i), this._axisLineWidth), m = [this.component.grid.getX(), f, this.component.grid.getXend(), f]), this._styleAxisPointer(c, m[0], m[1], m[2], m[3], o.getGap(), p, f)
            } else p = l.getX(this._event), f = l.getY(this._event), this._styleAxisPointer(h, this.component.grid.getX(), f, this.component.grid.getXend(), f, 0, p, f), i >= 0 ? this._showItemTrigger(!0) : (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), this._tDom.style.display = "none");
            if (c.length > 0) {
                var x, b;
                if (this._lastItemTriggerId = -1, this._lastDataIndex != i || this._lastSeriesIndex != d[0])
                    if (this._lastDataIndex = i, this._lastSeriesIndex = d[0], "function" == typeof n) {
                        var T = [];
                        for (y = 0, v = c.length; v > y; y++) x = c[y].data[i], b = this.getDataFromOption(x, "-"), T.push({
                            seriesIndex: d[y],
                            seriesName: c[y].name || "",
                            series: c[y],
                            dataIndex: i,
                        ...
                        this._curTicket = NaN, n = n.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}");
                        for (y = 0, v = c.length; v > y; y++) n = n.replace("{a" + y + "}", this._encodeHTML(c[y].name || "")), n = n.replace("{b" + y + "}", this._encodeHTML(o.getNameByIndex(i))), x = c[y].data[i], x = this.getDataFromOption(x, "-"), n = n.replace("{c" + y + "}", x instanceof Array ? x : this.numAddCommas(x));
                        this._tDom.innerHTML = n
                    } else {
                        this._curTicket = NaN, n = this._encodeHTML(o.getNameByIndex(i));
                        for (y = 0, v = c.length; v > y; y++) n += "<br/>" + this._encodeHTML(c[y].name || "") + " : ", x = c[y].data[i], x = this.getDataFromOption(x, "-"), n += x instanceof Array ? x : this.numAddCommas(x);
                        this._tDom.innerHTML = n
                    }
                if (!1 === a || !this.option.tooltip.showContent) return;
        ...
        _showPolarTrigger: function(t, e) {
            ...
            var i, o, n, r = this.option.series,
                s = [],
                a = [],
                h = "";
            if ("axis" === this.option.tooltip.trigger) {
            ...
            if (s.length > 0) {
                ...
                if (this._lastItemTriggerId = -1, this._lastDataIndex != e || this._lastSeriesIndex != a[0])
                    if (this._lastDataIndex = e, this._lastSeriesIndex = a[0], "function" == typeof i) this._curTicket = "axis:" + e, this._tDom.innerHTML = i.call(this.myChart, m, this._curTicket, this._setContent);
                        ...
                        for (d = 0, u = m.length; u > d; d++) i = i.replace("{a" + d + "}", this._encodeHTML(m[d].seriesName)), i = i.replace("{b" + d + "}", this._encodeHTML(m[d].name)), i = i.replace("{c" + d + "}", this.numAddCommas(m[d].value)), i = i.replace("{d" + d + "}", this._encodeHTML(m[d].indicator));
                        this._tDom.innerHTML = i
                    } else {
                        i = this._encodeHTML(m[0].name) + "<br/>" + this._encodeHTML(m[0].indicator) + " : " + this.numAddCommas(m[0].value);
                        for (d = 1, u = m.length; u > d; d++) i += "<br/>" + this._encodeHTML(m[d].name) + "<br/>", i += this._encodeHTML(m[d].indicator) + " : " + this.numAddCommas(m[d].value);
                        this._tDom.innerHTML = i
                    }
                if (!1 === n || !this.option.tooltip.showContent) return;
                return this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(o, l.getX(this._event), l.getY(this._event), h), !0
            }
        },
        _showItemTrigger: function(t) {
            if (this._curTarget) {
                var e, i, o, n = a.get(this._curTarget, "series"),
                    r = a.get(this._curTarget, "seriesIndex"),
                    h = a.get(this._curTarget, "data"),
                    c = a.get(this._curTarget, "dataIndex"),
                    d = a.get(this._curTarget, "name"),
                    u = a.get(this._curTarget, "value"),
                    p = a.get(this._curTarget, "special"),
                    f = a.get(this._curTarget, "special2"),
                    g = [h, n, this.option],
                    m = "";
                if ("island" != this._curTarget._type) {
                    var _ = t ? "axis" : "item";
                    this.option.tooltip.trigger === _ && (e = this.option.tooltip.formatter, i = this.option.tooltip.position), this.query(n, "tooltip.trigger") === _ && (o = this.query(n, "tooltip.showContent") || o, e = this.query(n, "tooltip.formatter") || e, i = this.query(n, "tooltip.position") || i, m += this._style(this.query(n, "tooltip"))), o = this.query(h, "tooltip.showContent") || o, e = this.query(h, "tooltip.formatter") || e, i = this.query(h, "tooltip.position") || i, m += this._style(this.query(h, "tooltip"))
                } else this._lastItemTriggerId = NaN, o = this.deepQuery(g, "tooltip.showContent"), e = this.deepQuery(g, "tooltip.islandFormatter"), i = this.deepQuery(g, "tooltip.islandPosition");
                this._lastDataIndex = -1, this._lastSeriesIndex = -1, this._lastItemTriggerId !== this._curTarget.id && (this._lastItemTriggerId = this._curTarget.id, "function" == typeof e ? (this._curTicket = (n.name || "") + ":" + c, this._tDom.innerHTML = e.call(this.myChart, {
                    seriesIndex: r,
                    seriesName: n.name || "",
                    series: n,
                    dataIndex: c,
                    ...
                    6: r,
                    7: c
                }, this._curTicket, this._setContent)) : "string" == typeof e ? (this._curTicket = NaN, e = (e = (e = (e = e.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}")).replace("{a0}", this._encodeHTML(n.name || "")).replace("{b0}", this._encodeHTML(d)).replace("{c0}", u instanceof Array ? u : this.numAddCommas(u))).replace("{d}", "{d0}").replace("{d0}", p || "")).replace("{e}", "{e0}").replace("{e0}", a.get(this._curTarget, "special2") || ""), this._tDom.innerHTML = e) : (this._curTicket = NaN, this._tDom.innerHTML = n.type === s.CHART_TYPE_RADAR && p ? this._itemFormatter.radar.call(this, n, d, u, p) : n.type === s.CHART_TYPE_EVENTRIVER ? this._itemFormatter.eventRiver.call(this, n, d, u, h) : (null != n.name ? this._encodeHTML(n.name) + "<br/>" : "") + ("" === d ? "" : this._encodeHTML(d) + " : ") + (u instanceof Array ? u : this.numAddCommas(u))));
                var y = l.getX(this._event),
                    v = l.getY(this._event);
                this.deepQuery(g, "tooltip.axisPointer.show") && this.component.grid ? this._styleAxisPointer([n], this.component.grid.getX(), v, this.component.grid.getXend(), v, 0, y, v) : this._hide(), !1 !== o && this.option.tooltip.showContent && (this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(i, y + 20, v - 20, m))
            }
        },
        _itemFormatter: {
            ...
            eventRiver: function(t, e, i, o) {
                var n = "";
                n += this._encodeHTML("" === t.name ? "" : t.name + " : "), n += this._encodeHTML(e), n += "" === n ? "" : "<br />";
                for (var r = 0, s = (o = o.evolution).length; s > r; r++) n += '<div style="padding-top:5px;">', o[r].detail && (o[r].detail.img && (n += '<img src="' + o[r].detail.img + '" style="float:left;width:40px;height:40px;">'), n += '<div style="margin-left:45px;">' + o[r].time + "<br/>", n += '<a href="' + o[r].detail.link + '" target="_blank">', n += o[r].detail.text + "</a></div>", n += "</div>");
                return n
            }
        },
        ...
        __onmousemove: function(t) {
            if (clearTimeout(this._hidingTicket), clearTimeout(this._showingTicket), !this._mousein || !this._enterable) {
                ...
                if (e) {
                    var n;
                    if (this._curTarget = e, this._event = t.event, this._event.zrenderX = i, this._event.zrenderY = o, this._needAxisTrigger && this.component.polar && -1 != (n = this.component.polar.isInside([i, o])))
                        for (var a = this.option.series, h = 0, d = a.length; d > h; h++)
                            if (a[h].polarIndex === n && "axis" === this.deepQuery([a[h], this.option], "tooltip.trigger")) {
                                this._curTarget = null;
                                break
                            }
                    this._showingTicket = setTimeout(this._tryShow, this._showDelay)
                } else this._curTarget = !1, this._event = t.event, this._event.zrenderX = i, this._event.zrenderY = o, this._needAxisTrigger && this.component.grid && c.isInside(r, this.component.grid.getArea(), i, o) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : this._needAxisTrigger && this.component.polar && -1 != this.component.polar.isInside([i, o]) ? this._showingTicket = setTimeout(this._tryShow, this._showDelay) : (!this._event.connectTrigger && this.messageCenter.dispatch(s.EVENT.TOOLTIP_OUT_GRID, this._event, null, this.myChart), this._hidingTicket = setTimeout(this._hide, this._hideDelay))
            }
        },
        ...
        ontooltipHover: function(t, e) {
            if (!this._lastTipShape || this._lastTipShape && this._lastTipShape.dataIndex != t.dataIndex) {
                ...
                for (var i = 0, o = e.length; o > i; i++) e[i].zlevel = this.getZlevelBase(), e[i].z = this.getZBase(), e[i].style = p.prototype.getHighlightStyle(e[i].style, e[i].highlightStyle), e[i].draggable = !1, e[i].hoverable = !1, e[i].clickable = !1, e[i].ondragend = null, e[i].ondragover = null, e[i].ondrop = null, this.shapeList.push(e[i]), this.zr.addShape(e[i]);
                this._lastTipShape = {
        ...
        _isSelected: function(t) {
            return null == this._selectedMap[t] || this._selectedMap[t]
        },
        showTip: function(t) {
            if (t) {
                ...
                if (null != t.seriesIndex) e = t.seriesIndex;
                    ...
                    for (var o = t.seriesName, n = 0, r = i.length; r > n; n++)
                        if (i[n].name === o) {
                            e = n;
                            break
                        } var l = i[e];
                if (null != l) {
                    var c = this.myChart.chart[l.type],
                        d = "axis" === this.deepQuery([l, this.option], "tooltip.trigger");
                    if (c)
                        if (d) {
                            var u = t.dataIndex;
                            switch (c.type) {
                                ...
                                case s.CHART_TYPE_RADAR:
                                    if (null == this.component.polar || l.data[0].value.length <= u) return;
                                    var p = l.polarIndex || 0,
                            ...
                            switch (c.type) {
                                ...
                                case s.CHART_TYPE_SCATTER:
                                    for (u = t.dataIndex, n = 0, r = _.length; r > n; n++)
                                        if (null == _[n]._mark && a.get(_[n], "seriesIndex") == e && a.get(_[n], "dataIndex") == u) {
                                            this._curTarget = _[n], g = _[n].style.x, m = c.type != s.CHART_TYPE_K ? _[n].style.y : _[n].style.y[0];
                                            break
                                        }
                                    break;
                                case s.CHART_TYPE_RADAR:
                                    for (u = t.dataIndex, n = 0, r = _.length; r > n; n++)
                                        if ("polygon" === _[n].type && a.get(_[n], "seriesIndex") == e && a.get(_[n], "dataIndex") == u) {
                                            this._curTarget = _[n], g = (f = this.component.polar.getCenter(l.polarIndex || 0))[0], m = f[1];
                                            break
                                        }
                                    break;
                                case s.CHART_TYPE_PIE:
                                    var y = t.name;
                                    for (n = 0, r = _.length; r > n; n++)
                                        if ("sector" === _[n].type && a.get(_[n], "seriesIndex") == e && a.get(_[n], "name") == y) {
                                            this._curTarget = _[n];
                                            var v = ((b = this._curTarget.style).startAngle + b.endAngle) / 2 * Math.PI / 180;
                                            g = this._curTarget.style.x + Math.cos(v) * b.r / 1.5, m = this._curTarget.style.y - Math.sin(v) * b.r / 1.5;
                                            break
                                        }
                                    break;
                                case s.CHART_TYPE_MAP:
                                    ...
                                    var x = l.mapType;
                                    for (n = 0, r = _.length; r > n; n++)
                                        if ("text" === _[n].type && _[n]._mapType === x && _[n].style._name === y) {
                                ...
                                case s.CHART_TYPE_CHORD:
                                    for (y = t.name, n = 0, r = _.length; r > n; n++)
                                        if ("sector" === _[n].type && a.get(_[n], "name") == y) {
                                            this._curTarget = _[n];
                                            var b;
                                            v = ((b = this._curTarget.style).startAngle + b.endAngle) / 2 * Math.PI / 180;
                                            return g = this._curTarget.style.x + Math.cos(v) * (b.r - 2), m = this._curTarget.style.y - Math.sin(v) * (b.r - 2), void this.zr.trigger(h.EVENT.MOUSEMOVE, {
                                                zrenderX: g,
                                                zrenderY: m
                                            })
                                        }
                                ...
                                case s.CHART_TYPE_FORCE:
                                    for (y = t.name, n = 0, r = _.length; r > n; n++)
                                        if ("circle" === _[n].type && a.get(_[n], "name") == y) {
        ...
        refresh: function(t) {
            ...
            if (this.showing) {
                var n = this;
                setTimeout(function() {
                    n.zr.trigger(h.EVENT.MOUSEMOVE, n.zr.handler._event)
                }, 50)
            }
        },
        onbeforDispose: function() {
    ...
    function e(t, e, o, n, r) {
        ...
        } else console.error("option.legend.data has not been defined.")
    }
    var i = t("./base"),
        o = t("zrender/shape/Text"),
        n = t("zrender/shape/Rectangle"),
    ...
    e.prototype = {
        ...
        _buildItem: function() {
            var t, e, i, n, r, a, h, d, u = this.legendOption.data,
                p = u.length,
        ...
        _getName: function(t) {
            return void 0 !== t.name ? t.name : t
        },
        _getFormatterName: function(t) {
            var e = this.legendOption.formatter;
            return "function" == typeof e ? e.call(this.myChart, t) : "string" == typeof e ? e.replace("{name}", t) : t
        },
        ...
        _mLineOptimize: function() {
            ...
            var n = -1;
            for (i = 1, o = this.shapeList.length; o > i; i++) this.shapeList[i].style.x === e && n++, 0 !== t[n] && (this.shapeList[i].style.x += t[n])
        },
        _buildBackground: function() {
        ...
        _getItemGroupLocation: function() {
            var t, e, i = this.legendOption.data,
                o = i.length,
                n = this.legendOption.itemGap,
                r = this.legendOption.itemWidth + 5,
                s = this.legendOption.itemHeight,
                a = this.legendOption.textStyle,
                h = this.getFont(a),
                d = 0,
                u = 0,
                p = this.reformCssArray(this.legendOption.padding),
                f = this.zr.getWidth() - p[1] - p[3],
                g = this.zr.getHeight() - p[0] - p[2],
                m = 0,
                _ = 0;
            if ("horizontal" === this.legendOption.orient) {
                u = s;
                for (var y = 0; o > y; y++)
                    if ("" !== this._getName(i[y])) {
                        var v = c.getTextWidth(this._getFormatterNameFromData(i[y]), i[y].textStyle ? this.getFont(l.merge(i[y].textStyle || {}, a)) : h);
                        m + r + v + n > f ? (m -= n, d = Math.max(d, m), u += s + n, m = 0) : (m += r + v + n, d = Math.max(d, m - n))
                    } else m -= n, d = Math.max(d, m), u += s + n, m = 0
            } else {
                for (y = 0; o > y; y++) _ = Math.max(_, c.getTextWidth(this._getFormatterNameFromData(i[y]), i[y].textStyle ? this.getFont(l.merge(i[y].textStyle || {}, a)) : h));
                d = _ += r;
                for (y = 0; o > y; y++) "" !== this._getName(i[y]) ? m + s + n > g ? (d += _ + n, m -= n, u = Math.max(u, m), m = 0) : (m += s + n, u = Math.max(u, m - n)) : (d += _ + n, m -= n, u = Math.max(u, m), m = 0)
            }
            switch (f = this.zr.getWidth(), g = this.zr.getHeight(), this.legendOption.x) {
                case "center":
                    t = Math.floor((f - d) / 2);
                    break;
                case "left":
                    t = p[3] + this.legendOption.borderWidth;
                    break;
                case "right":
                    t = f - d - p[1] - p[3] - 2 * this.legendOption.borderWidth;
                    break;
                default:
                    t = this.parsePercent(this.legendOption.x, f)
            }
            switch (this.legendOption.y) {
                case "top":
                    e = p[0] + this.legendOption.borderWidth;
                    break;
                case "bottom":
                    e = g - u - p[0] - p[2] - 2 * this.legendOption.borderWidth;
                    break;
                case "center":
                    e = Math.floor((g - u) / 2);
                    break;
        ...
        _getSomethingByName: function(t) {
            for (var e, i = this.option.series, o = 0, n = i.length; n > o; o++) {
                ...
                if (i[o].type === h.CHART_TYPE_PIE || i[o].type === h.CHART_TYPE_RADAR || i[o].type === h.CHART_TYPE_CHORD || i[o].type === h.CHART_TYPE_FORCE || i[o].type === h.CHART_TYPE_FUNNEL || i[o].type === h.CHART_TYPE_TREEMAP)
                    for (var r = 0, s = (e = i[o].categories || i[o].data || i[o].nodes).length; s > r; r++)
        ...
        _getItemShapeByType: function(t, e, i, o, n, r, s) {
            ...
            if (r.match("image")) {
                var c = r.replace(new RegExp("^image:\\/\\/"), "");
                r = "image"
            }
            switch (r) {
                case "line":
                ...
                case "scatter":
                    ...
                    break;
                case "k":
                    l.style.brushType = "both", l.highlightStyle.lineWidth = 3, l.highlightStyle.color = l.style.color = this.deepQuery([this.ecTheme, h], "k.itemStyle.normal.color") || "#fff", l.style.strokeColor = "#ccc" != n ? this.deepQuery([this.ecTheme, h], "k.itemStyle.normal.lineStyle.color") || "#ff3200" : n;
                    break;
                case "image":
                    l.style.iconType = "image", l.style.image = c, "#ccc" === n && (l.style.opacity = .5)
            }
            return l
        },
        ...
        refresh: function(t) {
            if (t) {
                ...
                if (this.legendOption.selected)
                    for (var s in this.legendOption.selected) this._selectedMap[s] = void 0 !== this._selectedMap[s] ? this._selectedMap[s] : this.legendOption.selected[s];
                for (var a = 0, l = r.length; l > a; a++) e = this._getName(r[a]), "" !== e && (i = this._getSomethingByName(e), i.series ? (this._hasDataMap[e] = !0, n = !i.data || i.type !== h.CHART_TYPE_PIE && i.type !== h.CHART_TYPE_FORCE && i.type !== h.CHART_TYPE_FUNNEL ? [i.series] : [i.data, i.series], o = this.getItemStyleColor(this.deepQuery(n, "itemStyle.normal.color"), i.seriesIndex, i.dataIndex, i.data), o && i.type != h.CHART_TYPE_K && this.setColor(e, o), this._selectedMap[e] = null == this._selectedMap[e] || this._selectedMap[e]) : this._hasDataMap[e] = !1)
            }
            this.clear(), this._buildShape()
        },
        getRelatedAmount: function(t) {
            for (var e, i = 0, o = this.option.series, n = 0, r = o.length; r > n; n++)
                if (o[n].name === t && i++, o[n].type === h.CHART_TYPE_PIE || o[n].type === h.CHART_TYPE_RADAR || o[n].type === h.CHART_TYPE_CHORD || o[n].type === h.CHART_TYPE_FORCE || o[n].type === h.CHART_TYPE_FUNNEL)
                    for (var s = 0, a = (e = o[n].type != h.CHART_TYPE_FORCE ? o[n].data : o[n].categories).length; a > s; s++) e[s].name === t && "-" != e[s].value && i++;
            return i
        },
        ...
        hasColor: function(t) {
            return !!this._colorMap[t] && this._colorMap[t]
        },
        add: function(t, e) {
        ...
        isSelected: function(t) {
            return void 0 === this._selectedMap[t] || this._selectedMap[t]
        },
    ...
    var d = {
        ...
        bar: function(t, e) {
            var i = e.x,
                ...
                n = e.width,
                r = e.height - 2;
            t.moveTo(i + 3, o), t.lineTo(i + n - 3, o), t.quadraticCurveTo(i + n, o, i + n, o + 3), t.lineTo(i + n, o + r - 3), t.quadraticCurveTo(i + n, o + r, i + n - 3, o + r), t.lineTo(i + 3, o + r), t.quadraticCurveTo(i, o + r, i, o + r - 3), t.lineTo(i, o + 3), t.quadraticCurveTo(i, o, i + 3, o)
        },
        force: function(t, e) {
        ...
        radar: function(t, e) {
            var i = e.x + e.width / 2,
                ...
                h = o + n * Math.sin(s);
            t.moveTo(a, h), s += r;
            for (var l = 0; 5 > l; l++) t.lineTo(i + n * Math.cos(s), o + n * Math.sin(s)), s += r;
            t.lineTo(a, h)
        }
    };
    ...
    return {
        pack: function(t, e, i, o, n, r, s, a) {
            var h;
            return void 0 !== o && (h = null == o.value ? o : o.value), t._echartsData = {
                _series: e,
                _seriesIndex: i,
                _data: o,
                _dataIndex: n,
    ...
    function e(t, e, o) {
        t = n(t), e = n(e), t = h(t);
        for (var r = [], s = ((e = h(e))[0] - t[0]) / o, a = (e[1] - t[1]) / o, l = (e[2] - t[2]) / o, d = (e[3] - t[3]) / o, u = 0, p = t[0], f = t[1], g = t[2], m = t[3]; o > u; u++) r[u] = i([c(Math.floor(p), [0, 255]), c(Math.floor(f), [0, 255]), c(Math.floor(g), [0, 255]), m.toFixed(4) - 0], "rgba"), p += s, f += a, g += l, m += d;
        return p = e[0], f = e[1], g = e[2], m = e[3], r[u] = i([p, f, g, m], "rgba"), r
    }
    ...
    function i(t, e) {
        if (e = e || "rgb", t && (3 === t.length || 4 === t.length)) {
            ...
            if (e.indexOf("hs") > -1) {
                var i = l(t.slice(1, 3), function(t) {
                    return t + "%"
                });
                t[1] = i[0], t[2] = i[1]
            }
            return e.indexOf("a") > -1 ? (3 === t.length && t.push(1), t[3] = c(t[3], [0, 1]), e + "(" + t.slice(0, 4).join(",") + ")") : e + "(" + t.slice(0, 3).join(",") + ")"
        }
    }
    ...
    function o(t, e) {
        ...
        var o = h(t),
            n = o[3];
        return void 0 === n && (n = 1), t.indexOf("hsb") > -1 ? o = function(t) {
            var e, i, o, n = t[0],
                r = t[1],
                s = t[2];
            ...
            return [e, i, o]
        }(o) : t.indexOf("hsl") > -1 && (o = function(t) {
            var e, i, o, n = t[0],
                r = t[1],
                s = t[2];
            if (0 === r) e = 255 * s, i = 255 * s, o = 255 * s;
            else {
                var a, h = 2 * s - (a = .5 > s ? s * (1 + r) : s + r - r * s);
                e = 255 * u(h, a, n + 1 / 3), i = 255 * u(h, a, n), o = 255 * u(h, a, n - 1 / 3)
            }
            return [e, i, o]
        }(o)), e.indexOf("hsb") > -1 || e.indexOf("hsv") > -1 ? o = function(t) {
            var e, i, o = t[0] / 255,
                n = t[1] / 255,
                r = t[2] / 255,
                s = Math.min(o, n, r),
            ...
            return [e *= 360, i *= 100, l *= 100]
        }(o) : e.indexOf("hsl") > -1 && (o = function(t) {
            var e, i, o = t[0] / 255,
                n = t[1] / 255,
                r = t[2] / 255,
                s = Math.min(o, n, r),
    ...
    function h(t) {
        var e = (t = function(t) {
            if (v[t] && (t = v[t]), t = (t = a(t)).replace(/hsv/i, "hsb"), /^#[\da-f]{3}$/i.test(t)) {
                var e = (3840 & (t = parseInt(t.slice(1), 16))) << 8,
                    i = (240 & t) << 4,
                    o = 15 & t;
        ...
        var i, o, n, r = [];
        if (e[2]) i = e[2].replace("#", "").split(""), n = [i[0] + i[1], i[2] + i[3], i[4] + i[5]], r = l(n, function(t) {
            return c(parseInt(t, 16), [0, 255])
        });
        else if (e[4]) {
            var s = e[4].split(",");
            o = s[3], r = l(n = s.slice(0, 3), function(t) {
                return c(t = Math.floor(t.indexOf("%") > 0 ? 2.55 * parseInt(t, 0) : t), [0, 255])
            }), void 0 !== o && r.push(c(parseFloat(o), [0, 1]))
        } else if (e[5] || e[6]) {
            var h = (e[5] || e[6]).split(","),
                d = parseInt(h[0], 0) / 360,
                u = h[1],
                p = h[2];
            o = h[3], (r = l([u, p], function(t) {
                return c(parseFloat(t) / 100, [0, 1])
            })).unshift(d), void 0 !== o && r.push(c(parseFloat(o), [0, 1]))
        }
        return r
    }
    ...
    var p, f = t("../tool/util"),
        g = ["#ff9277", " #dddd00", " #ffc877", " #bbe3ff", " #d5ffbb", "#bbbbff", " #ddb000", " #b0dd00", " #e2bbff", " #ffbbe3", "#ff7777", " #ff9900", " #83dd00", " #77e3ff", " #778fff", "#c877ff", " #ff77ab", " #ff6600", " #aa8800", " #77c7ff", "#ad77ff", " #ff77ff", " #dd0083", " #777700", " #00aa00", "#0088aa", " #8400dd", " #aa0088", " #dd0000", " #772e00"],
        m = g,
        _ = "rgba(255,255,0,0.5)",
    ...
    return {
        ...
        getColor: function(t, e) {
            return t |= 0, (e = e || g)[t % e.length]
        },
        getHighlightColor: function() {
            return _
        },
        customHighlight: function(t) {
            _ = t
        },
        resetHighlight: function() {
            _
        },
        getRadialGradient: function(t, e, i, o, n, r, s) {
            p || (p = f.getContext());
            for (var a = p.createRadialGradient(t, e, i, o, n, r), h = 0, l = s.length; l > h; h++) a.addColorStop(s[h][0], s[h][1]);
            return a.__nonRecursion = !0, a
        },
        getLinearGradient: function(t, e, i, o, n) {
            p || (p = f.getContext());
            for (var r = p.createLinearGradient(t, e, i, o), s = 0, a = n.length; a > s; s++) r.addColorStop(n[s][0], n[s][1]);
            return r.__nonRecursion = !0, r
        },
        getGradientColors: function(t, i) {
            var o = [],
                n = t.length;
            if (void 0 === i && (i = 20), 1 === n) o = e(t[0], t[0], i);
            else if (n > 1)
                for (var r = 0, s = n - 1; s > r; r++) {
                    var a = e(t[r], t[r + 1], i);
                    s - 1 > r && a.pop(), o = o.concat(a)
                }
            return o
        },
        getStepColors: e,
        ...
        mix: function(t, e, o) {
            if (!d(t) || !d(e)) return t;
            void 0 === o && (o = .5);
            for (var r = 2 * (o = 1 - c(o, [0, 1])) - 1, s = h(n(t)), a = h(n(e)), l = s[3] - a[3], u = ((r * l == -1 ? r : (r + l) / (1 + r * l)) + 1) / 2, p = 1 - u, f = [], g = 0; 3 > g; g++) f[g] = s[g] * u + a[g] * p;
            var m = s[3] * o + a[3] * (1 - o);
            return m = Math.max(0, Math.min(1, m)), 1 === s[3] && 1 === a[3] ? i(f, "rgb") : (f[3] = m, i(f, "rgba"))
        },
        lift: function(t, e) {
            if (!d(t)) return t;
            var i = e > 0 ? 1 : -1;
            void 0 === e && (e = 0), e = Math.abs(e) > 1 ? 1 : Math.abs(e);
            for (var o = h(t = r(t)), n = 0; 3 > n; n++) o[n] = 1 === i ? o[n] * (1 - e) | 0 : (255 - o[n]) * e + o[n] | 0;
            return "rgb(" + o.join(",") + ")"
        },
        trim: a,
        random: function() {
        ...
        toName: function(t) {
            for (var e in v)
                if (s(v[e]) === s(t)) return e;
            return null
        },
        toColor: i,
        toArray: function(t) {
            (t = a(t)).indexOf("rgba") < 0 && (t = n(t));
            var e = [],
                i = 0;
        ...
        alpha: function(t, e) {
            ...
            null === e && (e = 1);
            var o = h(n(t));
            return o[3] = c(Number(e).toFixed(4), [0, 1]), i(o, "rgba")
        },
        getData: h
    }
    ...
    function e(t, e, o, n, r) {
        if (i.call(this, t, e, o, n, r), (h = this)._onclick = function(t) {
            return h.__onclick(t)
        }, h._ondrift = function(t, e) {
            return h.__ondrift(this, t, e)
        }, h._ondragend = function() {
            return h.__ondragend()
        }, h._setCurrentOption = function() {
            var t = h.timelineOption;
            h.currentIndex %= t.data.length;
            var e = h.options[h.currentIndex] || {};
            h.myChart._setOption(e, t.notMerge, !0), h.messageCenter.dispatch(s.EVENT.TIMELINE_CHANGED, null, {
                currentIndex: h.currentIndex,
                data: null != t.data[h.currentIndex].name ? t.data[h.currentIndex].name : t.data[h.currentIndex]
            }, h.myChart)
        }, h._onFrame = function() {
            h._setCurrentOption(), h._syncHandleShape(), h.timelineOption.autoPlay && (h.playTicket = setTimeout(function() {
                return h.currentIndex += 1, !h.timelineOption.loop && h.currentIndex >= h.timelineOption.data.length ? (h.currentIndex = h.timelineOption.data.length - 1, void h.stop()) : void h._onFrame()
            }, h.timelineOption.playInterval))
        }, this.setTheme(!1), this.options = this.option.options, this.currentIndex = this.timelineOption.currentIndex % this.timelineOption.data.length, this.timelineOption.notMerge || 0 === this.currentIndex || (this.options[this.currentIndex] = a.merge(this.options[this.currentIndex], this.options[0])), this.timelineOption.show && (this._buildShape(), this._syncHandleShape()), this._setCurrentOption(), this.timelineOption.autoPlay) {
            var h = this;
    ...
    return e.prototype = {
        ...
        _buildShape: function() {
            ...
            e = 0;
            for (var o = this.shapeList.length; o > e; e++) this.zr.addShape(this.shapeList[e])
        },
        _getLocation: function() {
            ...
            null == e.width ? (t = o - n - r, r = o - r) : r = n + (t = this.parsePercent(e.width, o));
            var s, a, h = this.zr.getHeight(),
                l = this.parsePercent(e.height, h);
            return null != e.y ? a = (s = this.parsePercent(e.y, h)) + l : s = (a = h - this.parsePercent(e.y2, h)) - l, {
                x: n + i[3],
                y: s + i[0],
                x2: r - i[1],
                y2: a - i[2],
            ...
            if ("auto" === i) {
                ...
                if (r > 3) {
                    ...
                    for (i = 0; !l && r > i;) {
                        l = !0;
                        for (var c = ++i; r > c; c += i) {
                            if (s = t[c].x - t[c - i].x, 0 !== e.label.rotate) a = o;
                            else if (n[c].textStyle) a = h.getTextWidth(t[c].name, t[c].textFont);
                            else {
                                var d = t[c].name + "",
                                    u = (d.match(/\w/g) || "").length;
                                a = u * o * 2 / 3 + (d.length - u) * o
                            }
                            if (a > s) {
                                l = !1;
                                break
        ...
        _getChainPoint: function() {
            ...
            if (p > 1) {
                var g = u / p;
                if (u -= 2 * (g = g > 50 ? 50 : 20 > g ? 5 : g), "number" === i.type)
                    for (var m = 0; p > m; m++) f.push(c + g + u / (p - 1) * m);
                else {
                    f[0] = new Date(t(0).replace(/-/g, "/")), f[p - 1] = new Date(t(p - 1).replace(/-/g, "/")) - f[0];
                    for (m = 1; p > m; m++) f[m] = c + g + u * (new Date(t(m).replace(/-/g, "/")) - f[0]) / f[p - 1];
                    f[0] = c + g
                }
            } else f.push(c + u / 2);
            var _, y, v, x, b, T = [];
            for (m = 0; p > m; m++) c = f[m], _ = l[m].symbol && l[m].symbol.toLowerCase() || o, _.match("empty") ? (_ = _.replace("empty", ""), v = !0) : v = !1, _.match("star") && (y = _.replace("star", "") - 0 || 5, _ = "star"), e = l[m].textStyle ? a.merge(l[m].textStyle || {}, s) : s, x = e.align || "center", r ? (x = r > 0 ? "right" : "left", b = [r * Math.PI / 180, c, d - 5]) : b = !1, T.push({
                x: c,
                n: y,
                isEmpty: v,
                symbol: _,
                ...
                textX: c,
                textY: d - (r ? 5 : 0),
                textFont: l[m].textStyle ? this.getFont(e) : h,
                rotation: b,
                showLabel: !1
            });
            return T
        ...
        _buildControl: function() {
            ...
            if ("none" !== e.controlPosition) {
                var r, s = o.itemSize,
                    h = o.itemGap;
                "left" === e.controlPosition ? (r = this._location.x, this._location.x += 3 * (s + h)) : (r = this._location.x2 - (3 * (s + h) - h), this._location.x2 -= 3 * (s + h));
                ...
                this._ctrLastShape = new n(c), this._ctrLastShape.onclick = function() {
                    t.last()
                }, this.shapeList.push(this._ctrLastShape), r += s + h, this._ctrPlayShape = new n(a.clone(c)), this._ctrPlayShape.style.brushType = "fill", this._ctrPlayShape.style.symbol = "play", this._ctrPlayShape.style.status = this.timelineOption.autoPlay ? "playing" : "stop", this._ctrPlayShape.style.x = r, this._ctrPlayShape.onclick = function() {
                    "stop" === t._ctrPlayShape.style.status ? t.play() : t.stop()
                }, this.shapeList.push(this._ctrPlayShape), r += s + h, this._ctrNextShape = new n(a.clone(c)), this._ctrNextShape.style.symbol = "next", this._ctrNextShape.style.x = r, this._ctrNextShape.onclick = function() {
                    t.next()
                }, this.shapeList.push(this._ctrNextShape)
            }
        },
        _buildChain: function() {
            var t = this.timelineOption.lineStyle;
            this._timelineShae = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                style: {
        ...
        _syncHandleShape: function() {
            if (this.timelineOption.show) {
                ...
                this._handleShape.style.text = i.label.show ? o.name : "", this._handleShape.style.textFont = o.textFont, this._handleShape.style.n = o.n, "auto" === i.symbol ? this._handleShape.style.iconType = "none" != o.symbol ? o.symbol : "diamond" : (this._handleShape.style.iconType = i.symbol, i.symbol.match("star") && (this._handleShape.style.n = i.symbol.replace("star", "") - 0 || 5, this._handleShape.style.iconType = "star")), "auto" === i.symbolSize ? t = 5 > (t = o.symbolSize + 2) ? 5 : t : t = i.symbolSize - 0, this._handleShape.style.color = "auto" === i.color ? o.color ? o.color : e.controlStyle.emphasis.color : i.color, this._handleShape.style.textColor = "auto" === i.label.textStyle.color ? this._handleShape.style.color : i.label.textStyle.color, this._handleShape.highlightStyle.strokeColor = this._handleShape.style.strokeColor = "auto" === i.borderColor ? o.borderColor ? o.borderColor : "#fff" : i.borderColor, this._handleShape.style.lineWidth = "auto" === i.borderWidth ? o.borderWidth ? o.borderWidth : 0 : i.borderWidth - 0, this._handleShape.highlightStyle.lineWidth = this._handleShape.style.lineWidth + 1, this.zr.animate(this._handleShape.id, "style").when(500, {
                    x: o.x - t,
                    textX: o.x,
        ...
        __onclick: function(t) {
            ...
            return i === this.currentIndex || (this.currentIndex = i, this.timelineOption.autoPlay && this.stop(), clearTimeout(this.playTicket), void this._onFrame())
        },
        ...
        play: function(t, e) {
            return this._ctrPlayShape && "playing" != this._ctrPlayShape.style.status && (this._ctrPlayShape.style.status = "playing", this.zr.modShape(this._ctrPlayShape.id), this.zr.refreshNextFrame()), this.timelineOption.autoPlay = null == e || e, this.timelineOption.autoPlay || clearTimeout(this.playTicket), this.currentIndex = null != t ? t : this.currentIndex + 1, this.currentIndex >= this.timelineOption.data.length && (this.currentIndex = 0), this._onFrame(), this.currentIndex
        },
        stop: function() {
        ...
        setTheme: function(t) {
            this.timelineOption = this.reformOption(a.clone(this.option.timeline)), this.timelineOption.label.textStyle = this.getTextStyle(this.timelineOption.label.textStyle), this.timelineOption.checkpointStyle.label.textStyle = this.getTextStyle(this.timelineOption.checkpointStyle.label.textStyle), this.myChart.canvasSupported || (this.timelineOption.realtime = !1), this.timelineOption.show && t && (this.clear(), this._buildShape(), this._syncHandleShape())
        },
        onbeforDispose: function() {
            clearTimeout(this.playTicket)
        }
    }, n.prototype.iconLibrary.timelineControl = function(t, e) {
        var i = e.x + 2,
            o = e.y + 2 + 2,
            r = e.width - 2,
            s = e.height - 2,
            a = e.symbol;
        if ("last" === a) t.moveTo(i + r - 2, o + s / 3), t.lineTo(i + r - 2, o), t.lineTo(i + 2, o + s / 2), t.lineTo(i + r - 2, o + s), t.lineTo(i + r - 2, o + s / 3 * 2), t.moveTo(i, o), t.lineTo(i, o);
        else if ("next" === a) t.moveTo(i + 2, o + s / 3), t.lineTo(i + 2, o), t.lineTo(i + r - 2, o + s / 2), t.lineTo(i + 2, o + s), t.lineTo(i + 2, o + s / 3 * 2), t.moveTo(i, o), t.lineTo(i, o);
        else if ("play" === a)
            if ("stop" === e.status) t.moveTo(i + 2, o), t.lineTo(i + r - 2, o + s / 2), t.lineTo(i + 2, o + s), t.lineTo(i + 2, o);
            else {
                var h = "both" === e.brushType ? 2 : 3;
                t.rect(i + 2, o, h, s), t.rect(i + r - h - 2, o, h, s)
            }
        else if (a.match("image")) {
            var l;
            l = a.replace(new RegExp("^image:\\/\\/"), ""), (a = n.prototype.iconLibrary.image)(t, {
                x: i,
                y: o,
                width: r,
                height: s,
    ...
    }, a.inherits(e, i), t("../component").define("timeline", e), e
    ...
    return i.prototype = {
        ...
        brush: function(t, e, i) {
            ...
            if (this._imageCache || (this._imageCache = {}), "string" == typeof n) {
                var s = n;
                this._imageCache[s] ? n = this._imageCache[s] : ((n = new Image).onload = function() {
    ...
    return o.inherits(e, i), e.prototype._start = function(t, e) {
        ...
        for (var l = this.createTextShape(i.textStyle), c = this.createBackgroundShape(i.backgroundColor), d = a.x, u = a.y, p = a.r0 + 6, f = a.r - 6, g = a.color, m = n.lift(g, .1), _ = new r({
            highlightStyle: o.clone(a)
        }), y = [], v = n.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), x = 240, b = 0; 16 > b; b++) y.push(new s({
            highlightStyle: {
                x: d,
                y: u,
                r0: p,
            ...
            _color: n.getLinearGradient(d + p * Math.cos(x, !0), u - p * Math.sin(x, !0), d + p * Math.cos(x - 15, !0), u - p * Math.sin(x - 15, !0), [
                [0, v[2 * b]],
                [1, v[2 * b + 1]]
            ])
        })), x -= 15;
        x = 360;
        for (b = 0; 4 > b; b++) y.push(new s({
            highlightStyle: {
                x: d,
                y: u,
                r0: p,
        ...
        var T = 0;
        if (null != i.progress) {
            t(c), T = 100 * this.adjust(i.progress, [0, 1]).toFixed(2) / 5, _.highlightStyle.text = 5 * T + "%", t(_);
            for (b = 0; 20 > b; b++) y[b].highlightStyle.color = T > b ? y[b]._color : m, t(y[b]);
            return t(l), void e()
        }
        return setInterval(function() {
            t(c), T += T >= 20 ? -20 : 1, t(_);
    ...
    return o.inherits(e, i), e.prototype._start = function(t, e) {
        var i = o.merge(this.options, {
            ...
            h = r.getTextWidth(a.highlightStyle.text, a.highlightStyle.textFont),
            l = r.getTextHeight(a.highlightStyle.text, a.highlightStyle.textFont),
            ...
            d = this.getLocation(this.options.textStyle, h + 10 + 2 * c.r, Math.max(2 * c.r, l));
        c.x = d.x + c.r, c.y = a.highlightStyle.y = d.y + d.height / 2, a.highlightStyle.x = c.x + c.r + 10;
        for (var u = this.createBackgroundShape(i.backgroundColor), p = c.n, f = c.x, g = c.y, m = c.r0, _ = c.r, y = c.color, v = [], x = Math.round(180 / p), b = 0; p > b; b++) v[b] = new s({
            highlightStyle: {
                x: f,
                y: g,
                r0: m,
        ...
        return setInterval(function() {
            t(u), T[0] -= .3;
            for (var i = 0; p > i; i++) v[i].rotation = T, t(v[i]);
            t(a), e()
        }, c.timeInterval)
    }, e
    ...
    return o.inherits(e, i), e.prototype._start = function(t, e) {
        var i = o.merge(this.options, {
            ...
            l = n.getTextWidth(h.highlightStyle.text, h.highlightStyle.textFont),
            c = n.getTextHeight(h.highlightStyle.text, h.highlightStyle.textFont),
            d = o.merge(this.options.effect || {}, {
                r: 18,
                colorIn: "#fff",
                colorOut: "#555",
                colorWhirl: "#6cf",
            ...
            u = this.getLocation(this.options.textStyle, l + 10 + 2 * d.r, Math.max(2 * d.r, c));
        d.x = u.x + d.r, d.y = h.highlightStyle.y = u.y + u.height / 2, h.highlightStyle.x = d.x + d.r + 10;
        var p = this.createBackgroundShape(i.backgroundColor),
            f = new s({
                highlightStyle: {
                    a: Math.round(d.r / 2),
                    b: Math.round(d.r - d.r / 6),
                    brushType: "fill",
                    color: d.colorWhirl
                }
            }),
            ...
            _ = [0, d.x, d.y];
        return f.highlightStyle.x = g.highlightStyle.x = m.highlightStyle.x = _[1], f.highlightStyle.y = g.highlightStyle.y = m.highlightStyle.y = _[2], setInterval(function() {
            t(p), t(m), _[0] -= .3, f.rotation = _, t(f), t(g), t(h), e()
        }, d.timeInterval)
    }, e
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : function() {
        ...
        function u(t) {
            ...
            if ("#" == (t = String(t)).charAt(0)) n = t;
                ...
                for (var i, o = h(t), n = "#", r = 0; 3 > r; r++) i = -1 != o[r].indexOf("%") ? Math.floor(255 * l(o[r])) : +o[r], n += P[c(i, 0, 255)];
                e = +o[3]
            } else if (/^hsl/.test(t)) {
                n = function(t) {
                    var e, i, o, n, r, s;
                    if (0 > (n = parseFloat(t[0]) / 360 % 360) && n++, r = c(l(t[1]), 0, 1), s = c(l(t[2]), 0, 1), 0 == r) e = i = o = s;
                    else {
                        var a = .5 > s ? s * (1 + r) : s + r - s * r,
                            h = 2 * s - a;
                        e = d(h, a, n + 1 / 3), i = d(h, a, n), o = d(h, a, n - 1 / 3)
                    }
                    return "#" + P[Math.floor(255 * e)] + P[Math.floor(255 * i)] + P[Math.floor(255 * o)]
                }(o = h(t)), e = o[3]
            } else n = R[t] || t;
            return H[t] = {
                color: n,
        ...
        function p(t) {
            this.m_ = [
                ...
                [0, 1, 0],
                [0, 0, 1]
            ], this.mStack_ = [], this.aStack_ = [], this.currentPath_ = [], this.strokeStyle = "#000", this.fillStyle = "#000", this.lineWidth = 1, this.lineJoin = "miter", this.lineCap = "butt", this.miterLimit = 1 * A, this.globalAlpha = 1, this.font = "12px å¾®è½¯é›…é»‘", this.textAlign = "left", this.textBaseline = "alphabetic", this.canvas = t;
        ...
        function g(t, e) {
            var i, o = u(t.strokeStyle),
                n = o.color,
                r = o.alpha * t.globalAlpha,
                s = t.lineScale_ * t.lineWidth;
            1 > s && (r *= s), e.push("<g_vml_:stroke", ' opacity="', r, '"', ' joinstyle="', t.lineJoin, '"', ' miterlimit="', t.miterLimit, '"', ' endcap="', (i = t.lineCap, N[i] || "square"), '"', ' weight="', s, 'px"', ' color="', n, '" />')
        }
            ...
            if (n instanceof v) {
                ...
                if ("gradient" == n.type_) {
                    var f = n.x0_ / r,
                        ...
                        z = T.x - b.x,
                        C = T.y - b.y;
                    0 > (l = 180 * Math.atan2(z, C) / Math.PI) && (l += 360), 1e-6 > l && (l = 0)
                } else {
                    c = {
                        x: ((b = _(t, n.x0_, n.y0_)).x - i.x) / a,
                        y: (b.y - i.y) / h
                    }, a /= r * A, h /= s * A;
                    var E = S.max(a, h);
                    d = 2 * n.r0_ / E, p = 2 * n.r1_ / E - d
                }
                var w = n.colors_;
                w.sort(function(t, e) {
                    return t.offset - e.offset
                });
                for (var L = w.length, M = w[0].color, k = w[L - 1].color, O = w[0].alpha * t.globalAlpha, P = w[L - 1].alpha * t.globalAlpha, I = [], D = 0; L > D; D++) {
                    var R = w[D];
                    I.push(R.offset * p + d + " " + R.color)
                }
                e.push('<g_vml_:fill type="', n.type_, '"', ' method="none" focus="100%"', ' color="', M, '"', ' color2="', k, '"', ' colors="', I.join(","), '"', ' opacity="', P, '"', ' g_o_:opacity2="', O, '"', ' angle="', l, '"', ' focusposition="', c.x, ",", c.y, '" />')
            } else if (n instanceof x) {
                if (a && h) {
                    var H = -i.x,
                        F = -i.y;
                    e.push("<g_vml_:fill", ' position="', H / a * r * r, ",", F / h * s * s, '"', ' type="tile"', ' src="', n.src_, '" />')
                }
            } else {
                var B = u(t.fillStyle),
                    N = B.color,
                    Y = B.alpha * t.globalAlpha;
        ...
        function _(t, e, i) {
            var o = t.m_;
            return {
                x: A * (e * o[0][0] + i * o[1][0] + o[2][0]) - M,
                y: A * (e * o[0][1] + i * o[1][1] + o[2][1]) - M
            }
        }

        function y(t, e, i) {
            if (n = e, isFinite(n[0][0]) && isFinite(n[0][1]) && isFinite(n[1][0]) && isFinite(n[1][1]) && isFinite(n[2][0]) && isFinite(n[2][1]) && (t.m_ = e, t.scaleX_ = Math.sqrt(e[0][0] * e[0][0] + e[0][1] * e[0][1]), t.scaleY_ = Math.sqrt(e[1][0] * e[1][0] + e[1][1] * e[1][1]), i)) {
        ...
        function x(t, e) {
            switch ((i = t) && 1 == i.nodeType && "IMG" == i.tagName || b("TYPE_MISMATCH_ERR"), "complete" != i.readyState && b("INVALID_STATE_ERR"), e) {
                case "repeat":
                case null:
                case "":
        ...
        var S = Math,
            ...
            A = 10,
            M = A / 2,
            k = (navigator.userAgent.match(/MSIE ([\d.]+)?/)[1], Array.prototype.slice);
        o(document);
        var O = {
            init: function(t) {
                var e = t || document;
                e.createElement("canvas"), e.attachEvent("onreadystatechange", function(t, e) {
            ...
            initElement: function(e) {
                if (!e.getContext) {
                    e.getContext = t, o(e.ownerDocument), e.innerHTML = "", e.attachEvent("onpropertychange", n), e.attachEvent("onresize", r);
                    var i = e.attributes;
        ...
        O.init();
        for (var P = [], I = 0; 16 > I; I++)
            for (var D = 0; 16 > D; D++) P[16 * I + D] = I.toString(16) + D.toString(16);
        var R = {
                aliceblue: "#F0F8FF",
                antiquewhite: "#FAEBD7",
                aquamarine: "#7FFFD4",
        ...
        Y.clearRect = function() {
        ...
        }, Y.bezierCurveTo = function(t, e, i, o, n, r) {
            var s = _(this, n, r);
            f(this, _(this, t, e), _(this, i, o), s)
        }, Y.quadraticCurveTo = function(t, e, i, o) {
            var n = _(this, t, e),
                r = _(this, i, o),
                s = {
        ...
        }, Y.createLinearGradient = function(t, e, i, o) {
            var n = new v("gradient");
            return n.x0_ = t, n.y0_ = e, n.x1_ = i, n.y1_ = o, n
        }, Y.createRadialGradient = function(t, e, i, o, n, r) {
            var s = new v("gradientradial");
            return s.x0_ = t, s.y0_ = e, s.r0_ = i, s.x1_ = o, s.y1_ = n, s.r1_ = r, s
        }, Y.drawImage = function(t) {
            var e, i, o, n, r, s, a, h, l = t.runtimeStyle.width,
                c = t.runtimeStyle.height;
            t.runtimeStyle.width = "auto", t.runtimeStyle.height = "auto";
            var d = t.width,
                u = t.height;
            if (t.runtimeStyle.width = l, t.runtimeStyle.height = c, 3 == arguments.length) e = arguments[1], i = arguments[2], r = s = 0, a = o = d, h = n = u;
            else if (5 == arguments.length) e = arguments[1], i = arguments[2], o = arguments[3], n = arguments[4], r = s = 0, a = d, h = u;
            else {
            ...
            var p = _(this, e, i),
                f = [],
                g = y = 1;
            if (f.push(" <g_vml_:group", ' coordsize="', 10 * A, ",", 10 * A, '"', ' coordorigin="0,0"', ' style="width:', 10, "px;height:", 10, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                var m = [],
                    y = (g = this.scaleX_, this.scaleY_);
                m.push("M11=", this.m_[0][0] / g, ",", "M12=", this.m_[1][0] / y, ",", "M21=", this.m_[0][1] / g, ",", "M22=", this.m_[1][1] / y, ",", "Dx=", z(p.x / A), ",", "Dy=", z(p.y / A), "");
                var v = p,
                    x = _(this, e + o, i),
                    b = _(this, e, i + n),
                    T = _(this, e + o, i + n);
                v.x = S.max(v.x, x.x, b.x, T.x), v.y = S.max(v.y, x.y, b.y, T.y), f.push("padding:0 ", z(v.x / A), "px ", z(v.y / A), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", m.join(""), ", SizingMethod='clip');")
            } else f.push("top:", z(p.y / A), "px;left:", z(p.x / A), "px;");
            f.push(' ">'), (r || s) && f.push('<div style="overflow: hidden; width:', Math.ceil((o + r * o / a) * g), "px;", " height:", Math.ceil((n + s * n / h) * y), "px;", " filter:progid:DxImageTransform.Microsoft.Matrix(Dx=", -r * o / a * g, ",Dy=", -s * n / h * y, ');">'), f.push('<div style="width:', Math.round(g * d * o / a), "px;", " height:", Math.round(y * u * n / h), "px;", " filter:"), this.globalAlpha < 1 && f.push(" progid:DXImageTransform.Microsoft.Alpha(opacity=" + 100 * this.globalAlpha + ")"), f.push(" progid:DXImageTransform.Microsoft.AlphaImageLoader(src=", t.src, ',sizingMethod=scale)">'), (r || s) && f.push("</div>"), f.push("</div></div>"), this.element_.insertAdjacentHTML("BeforeEnd", f.join(""))
        }, Y.stroke = function(t) {
            var e = [];
            e.push("<g_vml_:shape", ' filled="', !!t, '"', ' style="position:absolute;width:', 10, "px;height:", 10, 'px;"', ' coordorigin="0,0"', ' coordsize="', 10 * A, ",", 10 * A, '"', ' stroked="', !t, '"', ' path="');
            for (var i = {
                x: null,
                y: null
            }, o = {
                x: null,
                y: null
            }, n = 0; n < this.currentPath_.length; n++) {
                var r = this.currentPath_[n];
                switch (r.type) {
                    case "moveTo":
                        r, e.push(" m ", z(r.x), ",", z(r.y));
                        break;
                    case "lineTo":
                        e.push(" l ", z(r.x), ",", z(r.y));
                        break;
                    case "close":
                        e.push(" x "), r = null;
                        break;
                    case "bezierCurveTo":
                        e.push(" c ", z(r.cp1x), ",", z(r.cp1y), ",", z(r.cp2x), ",", z(r.cp2y), ",", z(r.x), ",", z(r.y));
                        break;
                    case "at":
                    case "wa":
                        e.push(" ", r.type, " ", z(r.x - this.scaleX_ * r.radius), ",", z(r.y - this.scaleY_ * r.radius), " ", z(r.x + this.scaleX_ * r.radius), ",", z(r.y + this.scaleY_ * r.radius), " ", z(r.xStart), ",", z(r.yStart), " ", z(r.xEnd), ",", z(r.yEnd))
                }
                r && ((null == i.x || r.x < i.x) && (i.x = r.x), (null == o.x || r.x > o.x) && (o.x = r.x), (null == i.y || r.y < i.y) && (i.y = r.y), (null == o.y || r.y > o.y) && (o.y = r.y))
            }
            e.push(' ">'), t ? m(this, e, i, o) : g(this, e), e.push("</g_vml_:shape>"), this.element_.insertAdjacentHTML("beforeEnd", e.join(""))
        }, Y.fill = function() {
            this.stroke(!0)
            ...
            var t = {};
            a(this, t), this.aStack_.push(t), this.mStack_.push(this.m_), this.m_ = s([
                [1, 0, 0],
                [0, 1, 0],
                [0, 0, 1]
            ], this.m_)
        }, Y.restore = function() {
            this.aStack_.length && (a(this.aStack_.pop(), this), this.m_ = this.mStack_.pop())
        ...
        }, Y.scale = function(t, e) {
            y(this, s([
                [t, 0, 0],
                [0, e, 0],
                [0, 0, 1]
            ], this.m_), !0)
        }, Y.transform = function(t, e, i, o, n, r) {
            y(this, s([
                [t, e, 0],
                [i, o, 0],
                [n, r, 1]
            ], this.m_), !0)
        }, Y.setTransform = function(t, e, i, o, n, r) {
            y(this, [
                [t, e, 0],
                [i, o, 0],
                [n, r, 1]
            ], !0)
        }, Y.drawText_ = function(t, i, o, n, r) {
            var s, a = this.m_,
                h = 0,
                l = 1e3,
                c = {
                ...
                u = function(t, e) {
                    ...
                    try {
                        i.font = t, e = i.fontFamily.split(",")[0]
                    } catch (t) {}
                    return B[t] = {
                        style: i.fontStyle || F.style,
                        variant: i.fontVariant || F.variant,
                        weight: i.fontWeight || F.weight,
                        size: i.fontSize || F.size,
                        family: e || F.family
                    }
                }(this.font), this.element_),
                p = (s = u).style + " " + s.variant + " " + s.weight + " " + s.size + "px '" + s.family + "'",
                f = this.element_.currentStyle,
                y = this.textAlign.toLowerCase();
            switch (y) {
                case "left":
                case "center":
                case "right":
                    break;
                case "end":
                    y = "ltr" == f.direction ? "right" : "left";
                    break;
                case "start":
                    y = "rtl" == f.direction ? "right" : "left";
                    break;
                default:
                    y = "left"
            }
            ...
            var v = _(this, i + c.x, o + c.y);
            d.push('<g_vml_:line from="', -h, ' 0" to="', l, ' 0.05" ', ' coordsize="100 100" coordorigin="0 0"', ' filled="', !r, '" stroked="', !!r, '" style="position:absolute;width:1px;height:1px;">'), r ? g(this, d) : m(this, d, {
                x: -h,
                y: 0
            }, {
                x: l,
            ...
            var x = a[0][0].toFixed(3) + "," + a[1][0].toFixed(3) + "," + a[0][1].toFixed(3) + "," + a[1][1].toFixed(3) + ",0,0",
                b = z(v.x / A) + "," + z(v.y / A);
            d.push('<g_vml_:skew on="t" matrix="', x, '" ', ' offset="', b, '" origin="', h, ' 0" />', '<g_vml_:path textpathok="true" />', '<g_vml_:textpath on="true" string="', e(t), '" style="v-text-align:', y, ";font:", e(p), '" /></g_vml_:line>'), this.element_.insertAdjacentHTML("beforeEnd", d.join(""))
        }, Y.fillText = function(t, e, i, o) {
            this.drawText_(t, e, i, o, !1)
        }, Y.strokeText = function(t, e, i, o) {
            this.drawText_(t, e, i, o, !0)
        }, Y.measureText = function(t) {
            ...
            return this.textMeasureEl_.appendChild(e.createTextNode(t)), {
                width: this.textMeasureEl_.offsetWidth
            }
        }, Y.clip = function() {}, Y.arcTo = function() {}, Y.createPattern = function(t, e) {
            return new x(t, e)
        ...
        var W = T.prototype = new Error;
        W.INDEX_SIZE_ERR = 1, W.DOMSTRING_SIZE_ERR = 2, W.HIERARCHY_REQUEST_ERR = 3, W.WRONG_DOCUMENT_ERR = 4, W.INVALID_CHARACTER_ERR = 5, W.NO_DATA_ALLOWED_ERR = 6, W.NO_MODIFICATION_ALLOWED_ERR = 7, W.NOT_FOUND_ERR = 8, W.NOT_SUPPORTED_ERR = 9, W.INUSE_ATTRIBUTE_ERR = 10, W.INVALID_STATE_ERR = 11, W.SYNTAX_ERR = 12, W.INVALID_MODIFICATION_ERR = 13, W.NAMESPACE_ERR = 14, W.INVALID_ACCESS_ERR = 15, W.VALIDATION_ERR = 16, W.TYPE_MISMATCH_ERR = 17, G_vmlCanvasManager = O, CanvasRenderingContext2D = p, CanvasGradient = v, CanvasPattern = x, DOMException = T
    }(), G_vmlCanvasManager
    ...
    var o, n = t("./config"),
        ...
        p = function(t) {
            ...
            var e = (t = t || window.event).toElement || t.relatedTarget || t.srcElement || t.target;
        ...
        f = {
            ...
            mousewheel: function(t, e) {
                if (p(t) || e) {
                    var i = ((t = this._zrenderEventFixed(t)).wheelDelta || -t.detail) > 0 ? 1.1 : 1 / 1.1,
                        o = !1,
                        n = this._mouseX,
                        r = this._mouseY;
                    this.painter.eachBuildinLayer(function(e) {
                        ...
                        if (e.zoomable) {
                            e.__zoom = e.__zoom || 1;
                            var h = e.__zoom;
                            h *= i, h = Math.max(Math.min(e.maxZoom, h), e.minZoom), i = h / e.__zoom, e.__zoom = h, a[0] -= (n - a[0]) * (i - 1), a[1] -= (r - a[1]) * (i - 1), e.scale[0] *= i, e.scale[1] *= i, e.dirty = !0, o = !0, s.stop(t)
                        }
                    }), o && this.painter.refresh(), this._dispatchAgency(this._lastHover, c.MOUSEWHEEL, t), this._mousemoveHandler(t)
                }
            },
            mousemove: function(t, e) {
                if ((p(t) || e) && !this.painter.isLoading()) {
                    t = this._zrenderEventFixed(t), this._lastX = this._mouseX, this._lastY = this._mouseY, this._mouseX = s.getX(t), this._mouseY = s.getY(t);
            ...
            mouseout: function(t, e) {
                if (p(t) || e) {
                    var i = (t = this._zrenderEventFixed(t)).toElement || t.relatedTarget;
                    if (i != this.root)
                        for (; i && 9 != i.nodeType;) {
    ...
    }, g.prototype._iterateAndFindHover = (o = l.create(), function() {
        for (var t, e = this.storage.getShapeList(), i = [0, 0], n = e.length - 1; n >= 0; n--) {
            var r = e[n];
            if (void 0 !== r.zlevel && (t = this.painter.getLayer(r.zlevel, t), i[0] = this._mouseX, i[1] = this._mouseY, t.needTransform && (l.invert(o, t.transform), h.applyTransform(i, i, o))), this._findHover(r, i[0], i[1])) break
        }
    });
    var m = [{
        x: 10
    ...
    return g.prototype._mobileFindFixed = function(t) {
        ...
        if (e) {
            ...
            var n = (t = t || window.event).toElement || t.relatedTarget || t.srcElement || t.target;
            n && n != this._domHover && (t.zrenderX = (void 0 !== t.offsetX ? t.offsetX : t.layerX) + n.offsetLeft, t.zrenderY = (void 0 !== t.offsetY ? t.offsetY : t.layerY) + n.offsetTop)
        }
        return t.zrenderFixed = 1, t
    }, a.merge(g.prototype, d.prototype, !0), g
    ...
    return h.prototype.render = function(t) {
        ...
        var i, n, s;
        void 0 === e && (e = !1), this._updateLayerStatus(t), this.eachBuildinLayer(this._preProcessLayer);
        for (var a = 0, h = t.length; h > a; a++) {
            var l = t[a];
            if (n !== l.zlevel && (i && (i.needTransform && s.restore(), s.flush && s.flush()), n = l.zlevel, (i = this.getLayer(n)).isBuildin || r("ZLevel " + n + " has been used by unkown layer " + i.id), s = i.ctx, i.unusedCount = 0, (i.dirty || e) && i.clear(), i.needTransform && (s.save(), i.setTransform(s))), (i.dirty || e) && !l.invisible && (!l.onbrush || l.onbrush && !l.onbrush(s, !1)))
                if (o.catchBrushException) try {
                    l.brush(s, !1, this.refreshNextFrame)
                } catch (t) {
                    r(t, "brush error of " + l.type, l)
        ...
        return e || ((e = new a(t, this)).isBuildin = !0, this._layerConfig[t] && n.merge(e, this._layerConfig[t], !0), e.updateTransform(), this.insertLayer(t, e), e.initContext()), e
    }, h.prototype.insertLayer = function(t, e) {
        if (this._layers[t]) r("ZLevel " + t + " has been used already");
        else if ((i = e) && (i.isBuildin || "function" == typeof i.resize && "function" == typeof i.refresh)) {
            var i, o = this._zlevelList.length,
                n = null,
                s = -1;
            if (o > 0 && t > this._zlevelList[0]) {
                for (s = 0; o - 1 > s && !(this._zlevelList[s] < t && this._zlevelList[s + 1] > t); s++);
        ...
        this.storage.iterShape(function(t) {
            if (!t.invisible && (!t.onbrush || t.onbrush && !t.onbrush(s, !1)))
                if (o.catchBrushException) try {
                    t.brush(s, !1, h.refreshNextFrame)
                } catch (e) {
                    r(e, "brush error of " + t.type, t)
                } else t.brush(s, !1, h.refreshNextFrame)
        }, {
            normal: "up",
            update: !0
        });
        var l = n.dom.toDataURL(t, i);
        return s = null, this._bgDom.removeChild(n.dom), l
        ...
        if (!t.onbrush || t.onbrush && !t.onbrush(e, !0)) {
            ...
            if (i.needTransform && (e.save(), i.setTransform(e)), o.catchBrushException) try {
                ...
                r(e, "hoverBrush error of " + t.type, t)
            } else t.brush(e, !0, this.refreshNextFrame);
            i.needTransform && e.restore()
        }
    }, h.prototype._shapeToImage = function(e, i, o, n, r) {
        ...
        return null != h.position && (l.position = i.position = h.position), null != h.rotation && (l.rotation = i.rotation = h.rotation), null != h.scale && (l.scale = i.scale = h.scale), l
    ...
    return r.prototype.iterShape = function(t, e) {
        ...
        switch (e.update && this.updateShapeList(), e.normal) {
            case "down":
                for (o = this._shapeList.length; o--;)
                    if (t(this._shapeList[o])) return this;
                break;
            default:
                for (i = 0, o = this._shapeList.length; o > i; i++)
        ...
        for (var i = [], o = 0, n = this._hoverElements.length; n > o; o++) {
            ...
            if (r)
                for (var s, a = 0, h = (r = r instanceof Array ? r : [r]).length; h > a; a++) s = r[a].id ? r[a] : this.get(r[a]), s && i.push(s)
        }
        if (i.sort(e), t)
            for (o = 0, n = i.length; n > o; o++) i[o].updateTransform();
        return i
        ...
        for (t = 0, i = this._shapeList.length; i > t; t++) this._shapeList[t].__renderidx = t;
        ...
        if (t instanceof Array) {
            e = 0;
            for (var r = t.length; r > e; e++) this.delRoot(t[e])
        } else {
            var s;
    ...
    function n(t, e, i, n, r) {
        var s = t.length;
        if (1 == r)
            for (var a = 0; s > a; a++) n[a] = o(t[a], e[a], i);
        else {
            var h = t[0].length;
            for (a = 0; s > a; a++)
    ...
    function s(t, e, i, o, n, r, s, h, l) {
        var c = t.length;
        if (1 == l)
            for (var d = 0; c > d; d++) h[d] = a(t[d], e[d], i[d], o[d], n, r, s);
        else {
            var u = t[0].length;
            for (d = 0; c > d; d++)
                for (var p = 0; u > p; p++) h[d][p] = a(t[d][p], e[d][p], i[d][p], o[d][p], n, r, s)
        }
    }
    ...
    m.prototype = {
        ...
        _update: function() {
            ...
            for (s = 0; o > s;) i[s].__needsRemove ? (i[s] = i[o - 1], i.pop(), o--) : s++;
            o = n.length;
            for (s = 0; o > s; s++) r[s].fire(n[s]);
            this._time = t, this.onframe(e), this.dispatch("frame", e), this.stage.update && this.stage.update()
        },
        start: function() {
            var t = this;
            this._running = !0, this._time = (new Date).getTime(), f(function e() {
                t._running && (f(e), t._update())
            })
        },
        stop: function() {
            this._running = !1
                    ...
                    if (m) {
                        ...
                        if (f.sort(function(t, e) {
                            ...
                            for (var T = [], S = [], z = 0; m > z; z++) {
                                T.push(f[z].time / _);
                                var C = f[z].value;
                                "string" == typeof C && (0 === (C = d.toArray(C)).length && (C[0] = C[1] = C[2] = 0, C[3] = 1), x = !0), S.push(C)
                            }
                            var E, w, L, A, M, k, O = 0,
                                P = 0;
                            if (x) var I = [0, 0, 0, 0];
                            var D = new c({
                                ...
                                loop: e._loop,
                                delay: e._delay,
                                onframe: function(t, r) {
                                    if (P > r) {
                                        for (E = Math.min(O + 1, m - 1), z = E; z >= 0 && !(T[z] <= r); z--);
                                        z = Math.min(z, m - 2)
                                    } else {
                                        for (z = O; m > z && !(T[z] > r); z++);
                                        z = Math.min(z - 1, m - 2)
                                    ...
                                    var c = T[z + 1] - T[z];
                                    if (0 !== c) {
                                        if (w = (r - T[z]) / c, u) A = S[z], L = S[0 === z ? z : z - 1], M = S[z > m - 2 ? m - 1 : z + 1], k = S[z > m - 3 ? m - 1 : z + 2], v ? s(L, A, M, k, w, w * w, w * w * w, h(t, g), b) : (x ? (d = s(L, A, M, k, w, w * w, w * w * w, I, 1), d = l(I)) : d = a(L, A, M, k, w, w * w, w * w * w), i(t, g, d));
                                        else if (v) n(S[z], S[z + 1], w, h(t, g), b);
                                        else {
                                            var d;
                                            x ? (n(S[z], S[z + 1], w, I, 1), d = l(I)) : d = o(S[z], S[z + 1], w), i(t, g, d)
                                        }
    ...
    return e.prototype.createTextShape = function(t) {
        ...
        this.canvasWidth = t._width, this.canvasHeight = t._height, this.loadingTimer = this._start(function(e) {
    ...
    return o.prototype = {
        ...
        brush: function(t, i) {
            var o = this.style;
            if (i && (o = this.getHighlightStyle(o, this.highlightStyle || {})), void 0 !== o.text && !1 !== o.text) {
                ...
                var n, r = (o.text + "").split("\n"),
                    s = e.getTextHeight("å›½", o.textFont),
                    a = this.getRect(o),
                    h = o.x;
        ...
        getRect: function(t) {
            ...
            var i, o = e.getTextWidth(t.text, t.textFont),
                n = e.getTextHeight(t.text, t.textFont),
                r = t.x;
            return "end" == t.textAlign || "right" == t.textAlign ? r -= o : "center" == t.textAlign && (r -= o / 2), i = "top" == t.textBaseline ? t.y : "bottom" == t.textBaseline ? t.y - n : t.y - n / 2, t.__rect = {
                x: r,
                y: i,
                width: o,
                height: n
    ...
    return i.prototype = {
        ...
        _buildRadiusPath: function(t, e) {
            var i, o, n, r, s, a = e.x,
                ...
                c = e.height,
                d = e.radius;
            "number" == typeof d ? i = o = n = r = d : d instanceof Array ? 1 === d.length ? i = o = n = r = d[0] : 2 === d.length ? (i = n = d[0], o = r = d[1]) : 3 === d.length ? (i = d[0], o = r = d[1], n = d[2]) : (i = d[0], o = d[1], n = d[2], r = d[3]) : i = o = n = r = 0, i + o > l && (i *= l / (s = i + o), o *= l / s), n + r > l && (n *= l / (s = n + r), r *= l / s), o + n > c && (o *= c / (s = o + n), n *= c / s), i + r > c && (i *= c / (s = i + r), r *= c / s), t.moveTo(a + i, h), t.lineTo(a + l - o, h), 0 !== o && t.quadraticCurveTo(a + l, h, a + l, h + o), t.lineTo(a + l, h + c - n), 0 !== n && t.quadraticCurveTo(a + l, h + c, a + l - n, h + c), t.lineTo(a + r, h + c), 0 !== r && t.quadraticCurveTo(a, h + c, a, h + c - r), t.lineTo(a, h + i), 0 !== i && t.quadraticCurveTo(a, h, a + i, h)
        },
        ...
        getRect: function(t) {
            return t.__rect ? t.__rect : (e = "stroke" == t.brushType || "fill" == t.brushType ? t.lineWidth || 1 : 0, t.__rect = {
    ...
    function i(t, e, i, s) {
        ...
        var u = t.type;
        _ = _ || y.getContext();
        var p, f, g, v, x, b = function(t, e, i, s) {
            switch (t.type) {
                case "bezier-curve":
                    return void 0 === e.cpX2 ? r(e.xStart, e.yStart, e.cpX1, e.cpY1, e.xEnd, e.yEnd, e.lineWidth, i, s) : n(e.xStart, e.yStart, e.cpX1, e.cpY1, e.cpX2, e.cpY2, e.xEnd, e.yEnd, e.lineWidth, i, s);
                case "line":
                    return o(e.xStart, e.yStart, e.xEnd, e.yEnd, e.lineWidth, i, s);
                case "polyline":
                    return a(e.pointList, e.lineWidth, i, s);
                case "ring":
                    return g = e.x, _ = e.y, y = e.r0, (v = e.r) * v > (T = ((x = i) - g) * (x - g) + ((b = s) - _) * (b - _)) && T > y * y;
                case "circle":
                    return l(e.x, e.y, e.r, i, s);
                case "sector":
                    var u = e.startAngle * Math.PI / 180,
                        p = e.endAngle * Math.PI / 180;
                    return e.clockWise || (u = -u, p = -p), c(e.x, e.y, e.r0, e.r, u, p, !e.clockWise, i, s);
                case "path":
                    return e.pathArray && m(e.pathArray, Math.max(e.lineWidth, 5), e.brushType, i, s);
                case "polygon":
                case "star":
                case "isogon":
                    return d(e.pointList, i, s);
                case "text":
                    var f = e.__rect || t.getRect(e);
                    return h(f.x, f.y, f.width, f.height, i, s);
                case "rectangle":
                case "image":
                    return h(e.x, e.y, e.width, e.height, i, s)
            }
            var g, _, y, v, x, b, T
        }(t, e, i, s);
        if (void 0 !== b) return b;
        if (t.buildPath && _.isPointInPath) return p = t, f = _, g = e, v = i, x = s, f.beginPath(), p.buildPath(f, g), f.closePath(), f.isPointInPath(v, x);
        switch (u) {
            case "ellipse":
                return !0;
            case "trochoid":
                return l(e, i, s, "out" == e.location ? e.r1 + e.r2 + e.d : e.r1 - e.r2 + e.d);
            case "rose":
                return l(e, i, s, e.maxr);
            default:
                return !1
        }
    }
    ...
    function o(t, e, i, o, n, r, s) {
        if (0 === n) return !1;
        var a, h = Math.max(n, 5);
        if (s > e + h && s > o + h || e - h > s && o - h > s || r > t + h && r > i + h || t - h > r && i - h > r) return !1;
        if (t === i) return Math.abs(r - t) <= h / 2;
        var l = (a = (e - o) / (t - i)) * r - s + (t * o - i * e) / (t - i);
        return h / 2 * h / 2 >= l * l / (a * a + 1)
    }

    function n(t, e, i, o, n, r, s, a, h, l, c) {
        if (0 === h) return !1;
        var d = Math.max(h, 5);
        return !(c > e + d && c > o + d && c > r + d && c > a + d || e - d > c && o - d > c && r - d > c && a - d > c || l > t + d && l > i + d && l > n + d && l > s + d || t - d > l && i - d > l && n - d > l && s - d > l) && d / 2 >= v.cubicProjectPoint(t, e, i, o, n, r, s, a, l, c, null)
    }

    function r(t, e, i, o, n, r, s, a, h) {
        if (0 === s) return !1;
        var l = Math.max(s, 5);
        return !(h > e + l && h > o + l && h > r + l || e - l > h && o - l > h && r - l > h || a > t + l && a > i + l && a > n + l || t - l > a && i - l > a && n - l > a) && l / 2 >= v.quadraticProjectPoint(t, e, i, o, n, r, a, h, null)
    }

    function s(t, i, o, n, r, s, a, h, l) {
        if (0 === a) return !1;
        var c = Math.max(a, 5);
        h -= t, l -= i;
        var d = Math.sqrt(h * h + l * l);
        if (d - c > o || o > d + c) return !1;
        if (Math.abs(n - r) >= C) return !0;
        if (s) {
            var u = n;
            n = e(r), r = e(u)
        } else n = e(n), r = e(r);
        ...
        return 0 > p && (p += C), p >= n && r >= p || p + C >= n && r >= p + C
    }

    function a(t, e, i, n) {
        e = Math.max(e, 10);
        for (var r = 0, s = t.length - 1; s > r; r++) {
            if (o(t[r][0], t[r][1], t[r + 1][0], t[r + 1][1], e, i, n)) return !0
        }
        return !1
    }
    ...
    function c(t, e, i, o, n, r, a, h, l) {
        return s(t, e, (i + o) / 2, n, r, a, o - i, h, l)
    }

    function d(t, e, i) {
        for (var o = t.length, n = 0, r = 0, s = o - 1; o > r; r++) {
            n += u(t[s][0], t[s][1], t[r][0], t[r][1], e, i), s = r
        }
        return 0 !== n
    }

    function u(t, e, i, o, n, r) {
        return r > e && r > o || e > r && o > r ? 0 : o == e ? 0 : (r - e) / (o - e) * (i - t) + t > n ? e > o ? 1 : -1 : 0
    }

    function p(t, e, i, o, n, r, s, a, h, l) {
        if (l > e && l > o && l > r && l > a || e > l && o > l && r > l && a > l) return 0;
        var c, d = v.cubicRootAt(e, o, r, a, l, E);
        if (0 === d) return 0;
        for (var u, p, f = 0, g = -1, m = 0; d > m; m++) {
            var _ = E[m];
            h > v.cubicAt(t, i, n, s, _) || (0 > g && (g = v.cubicExtrema(e, o, r, a, w), w[1] < w[0] && g > 1 && (void 0, c = w[0], w[0] = w[1], w[1] = c), u = v.cubicAt(e, o, r, a, w[0]), g > 1 && (p = v.cubicAt(e, o, r, a, w[1]))), f += 2 == g ? _ < w[0] ? e > u ? 1 : -1 : _ < w[1] ? u > p ? 1 : -1 : p > a ? 1 : -1 : _ < w[0] ? e > u ? 1 : -1 : u > a ? 1 : -1)
        }
        return f
    }

    function f(t, e, i, o, n, r, s, a) {
        if (a > e && a > o && a > r || e > a && o > a && r > a) return 0;
        var h = v.quadraticRootAt(e, o, r, a, E);
        if (0 === h) return 0;
        var l = v.quadraticExtremum(e, o, r);
        if (l >= 0 && 1 >= l) {
            for (var c = 0, d = v.quadraticAt(e, o, r, l), u = 0; h > u; u++) {
                s > v.quadraticAt(t, i, n, E[u]) || (c += E[u] < l ? e > d ? 1 : -1 : d > r ? 1 : -1)
            }
            return c
        }
        return s > v.quadraticAt(t, i, n, E[0]) ? 0 : e > r ? 1 : -1
    }

    function g(t, i, o, n, r, s, a, h) {
        if ((h -= i) > o || -o > h) return 0;
        var l = Math.sqrt(o * o - h * h);
        if (E[0] = -l, E[1] = l, Math.abs(n - r) >= C) {
            n = 0, r = C;
            var c = s ? 1 : -1;
            return a >= E[0] + t && a <= E[1] + t ? c : 0
        }
        if (s) {
            l = n;
            n = e(r), r = e(l)
        ...
        for (var d = 0, u = 0; 2 > u; u++) {
            ...
            if (p + t > a) {
                ...
                c = s ? 1 : -1;
                0 > f && (f = C + f), (f >= n && r >= f || f + C >= n && r >= f + C) && (f > Math.PI / 2 && f < 1.5 * Math.PI && (c = -c), d += c)
            }
        }
        return d
    }

    function m(t, e, i, a, h) {
        for (var l = 0, c = 0, d = 0, m = 0, _ = 0, y = !0, v = !0, x = "stroke" === (i = i || "fill") || "both" === i, b = "fill" === i || "both" === i, T = 0; T < t.length; T++) {
            var S = t[T],
                z = S.points;
            if (y || "M" === S.command) {
                if (T > 0 && (b && (l += u(c, d, m, _, a, h)), 0 !== l)) return !0;
                m = z[z.length - 2], _ = z[z.length - 1], y = !1, v && "A" !== S.command && (v = !1, c = m, d = _)
            }
            switch (S.command) {
                case "M":
                    c = z[0], d = z[1];
                    break;
                case "L":
                    if (x && o(c, d, z[0], z[1], e, a, h)) return !0;
                    b && (l += u(c, d, z[0], z[1], a, h)), c = z[0], d = z[1];
                    break;
                case "C":
                    if (x && n(c, d, z[0], z[1], z[2], z[3], z[4], z[5], e, a, h)) return !0;
                    b && (l += p(c, d, z[0], z[1], z[2], z[3], z[4], z[5], a, h)), c = z[4], d = z[5];
                    break;
                case "Q":
                    if (x && r(c, d, z[0], z[1], z[2], z[3], e, a, h)) return !0;
                    b && (l += f(c, d, z[0], z[1], z[2], z[3], a, h)), c = z[2], d = z[3];
                    break;
                case "A":
                    var C = z[0],
                        E = z[1],
                        ...
                        k = Math.cos(A) * w + C,
                        O = Math.sin(A) * L + E;
                    v ? (v = !1, m = k, _ = O) : l += u(c, d, k, O);
                    var P = (a - C) * L / w + C;
                    if (x && s(C, E, L, A, A + M, 1 - z[7], e, P, h)) return !0;
                    b && (l += g(C, E, L, A, A + M, 1 - z[7], P, h)), c = Math.cos(A + M) * w + C, d = Math.sin(A + M) * L + E;
                    break;
                case "z":
                    if (x && o(c, d, m, _, e, a, h)) return !0;
                    y = !0
            }
        }
        return b && (l += u(c, d, m, _, a, h)), 0 !== l
    }
    var _, y = t("./util"),
        v = t("./curve"),
        x = {},
    ...
    return {
        isInside: i,
        isOutside: function(t, e, o, n) {
            return !i(t, e, o, n)
        },
        getTextWidth: function(t, e) {
            var i = t + ":" + e;
            if (x[i]) return x[i];
            (_ = _ || y.getContext()).save(), e && (_.font = e);
            for (var o = 0, n = 0, r = (t = (t + "").split("\n")).length; r > n; n++) o = Math.max(_.measureText(t[n]).width, o);
            return _.restore(), x[i] = o, ++T > z && (T = 0, x = {}), o
        },
        getTextHeight: function(t, e) {
            var i = t + ":" + e;
            if (b[i]) return b[i];
            (_ = _ || y.getContext()).save(), e && (_.font = e), t = (t + "").split("\n");
            var o = (_.measureText("å›½").width + 2) * t.length;
            return _.restore(), b[i] = o, ++S > z && (S = 0, b = {}), o
        },
        isInsidePath: m,
        isInsidePolygon: d,
        isInsideSector: c,
    ...
    function e(e, i, o, n, r, s, a) {
        r && (e.font = r), e.textAlign = s, e.textBaseline = a;
        var h = function(e, i, o, n, r, s) {
            var a = t("../tool/area"),
                h = a.getTextWidth(e, n),
                l = a.getTextHeight("å›½", n);
            switch (e = (e + "").split("\n"), r) {
                case "end":
                case "right":
                    i -= h;
        ...
        i = (i + "").split("\n");
        var l = t("../tool/area").getTextHeight("å›½", r);
        switch (a) {
            case "top":
                n = h.y;
                break;
        ...
        for (var c = 0, d = i.length; d > c; c++) e.fillText(i[c], o, n), n += l
    }
    var i = window.G_vmlCanvasManager,
        ...
        r = t("../tool/util"),
        s = t("../tool/log"),
        a = t("../mixin/Transformable"),
        h = t("../mixin/Eventful"),
        l = function(t) {
            t = t || {}, this.id = t.id || n();
            for (var e in t) this[e] = t[e];
            this.style = this.style || {}, this.highlightStyle = this.highlightStyle || null, this.parent = null, this.__dirty = !0, this.__clipShapes = [], a.call(this), h.call(this)
        };
    l.prototype.invisible = !1, l.prototype.ignore = !1, l.prototype.zlevel = 0, l.prototype.draggable = !1, l.prototype.clickable = !1, l.prototype.hoverable = !0, l.prototype.z = 0, l.prototype.brush = function(t, e) {
    ...
    }, l.prototype.beforeBrush = function(t, e) {
        var i = this.style;
    ...
    }, l.prototype.afterBrush = function(t) {
        t.restore()
    };
    var c = [
        ["color", "fillStyle"],
    ...
    l.prototype.setContext = function(t, e) {
    ...
    var d = o.create();
    return l.prototype.doClip = function(t) {
        if (this.__clipShapes && !i)
            for (var e = 0; e < this.__clipShapes.length; e++) {
                var n = this.__clipShapes[e];
                if (n.needTransform) {
                    var r = n.transform;
                    o.invert(d, r), t.transform(r[0], r[1], r[2], r[3], r[4], r[5])
                }
                if (t.beginPath(), n.buildPath(t, n.style), t.clip(), n.needTransform) {
                    r = d;
                    t.transform(r[0], r[1], r[2], r[3], r[4], r[5])
                }
            }
    }, l.prototype.getHighlightStyle = function(e, i, o) {
        var n = {};
        ...
        if (void 0 !== i.text && !1 !== i.text) {
            ...
            switch (c) {
                ...
                case "end":
                    ...
                    switch (c) {
                        case "start":
                            u = m[1][0], p = m[0][0], f = m[1][1], g = m[0][1];
                            break;
                        case "end":
                            u = m[_ - 2][0], p = m[_ - 1][0], f = m[_ - 2][1], g = m[_ - 1][1]
                    }
                    a = p, h = g;
                    var y = Math.atan((f - g) / (p - u)) / Math.PI * 180;
                    0 > p - u ? y += 180 : 0 > f - g && (y += 360), l = 5, y >= 30 && 150 >= y ? (r = "center", s = "bottom", h -= l) : y > 150 && 210 > y ? (r = "right", s = "middle", a -= l) : y >= 210 && 330 >= y ? (r = "center", s = "top", h += l) : (r = "left", s = "middle", a += l);
                    break;
                case "specific":
    ...
    }, r.merge(l.prototype, a.prototype, !0), r.merge(l.prototype, h.prototype, !0), l
    ...
    return {
        cubicAt: o,
        cubicDerivativeAt: function(t, e, i, o, n) {
            var r = 1 - n;
            return 3 * (((e - t) * r + 2 * (i - e) * n) * r + (o - i) * n * n)
        },
        cubicRootAt: function(t, i, o, n, r, s) {
            var l = n + 3 * (i - o) - t,
                c = 3 * (o - 2 * i + t),
                d = 3 * (i - t),
                u = t - r,
                ...
                g = d * d - 3 * c * u,
                m = 0;
            if (e(p) && e(f)) e(c) ? s[0] = 0 : (w = -d / c) >= 0 && 1 >= w && (s[m++] = w);
            else {
                var _ = f * f - 4 * p * g;
                if (e(_)) {
                    var y = f / p,
                        v = -y / 2;
                    (w = -c / l + y) >= 0 && 1 >= w && (s[m++] = w), v >= 0 && 1 >= v && (s[m++] = v)
                } else if (_ > 0) {
                    var x = Math.sqrt(_),
                        b = p * c + 1.5 * l * (-f + x),
                        T = p * c + 1.5 * l * (-f - x);
                    (w = (-c - ((b = 0 > b ? -Math.pow(-b, h) : Math.pow(b, h)) + (T = 0 > T ? -Math.pow(-T, h) : Math.pow(T, h)))) / (3 * l)) >= 0 && 1 >= w && (s[m++] = w)
                } else {
                    var S = (2 * p * c - 3 * l * f) / (2 * Math.sqrt(p * p * p)),
                        z = Math.acos(S) / 3,
                        C = Math.sqrt(p),
                        E = Math.cos(z),
                        w = (-c - 2 * C * E) / (3 * l),
                        L = (v = (-c + C * (E + a * Math.sin(z))) / (3 * l), (-c + C * (E - a * Math.sin(z))) / (3 * l));
                    w >= 0 && 1 >= w && (s[m++] = w), v >= 0 && 1 >= v && (s[m++] = v), L >= 0 && 1 >= L && (s[m++] = L)
                }
            }
            return m
        },
        cubicExtrema: function(t, o, n, r, s) {
            var a = 6 * n - 12 * o + 6 * t,
                h = 9 * o + 3 * r - 3 * t - 9 * n,
                l = 3 * o - 3 * t,
                c = 0;
            if (e(h)) i(a) && (u = -l / a) >= 0 && 1 >= u && (s[c++] = u);
            else {
                var d = a * a - 4 * h * l;
                if (e(d)) s[0] = -a / (2 * h);
                else if (d > 0) {
                    var u, p = Math.sqrt(d),
                        f = (-a - p) / (2 * h);
                    (u = (-a + p) / (2 * h)) >= 0 && 1 >= u && (s[c++] = u), f >= 0 && 1 >= f && (s[c++] = f)
                }
            }
            return c
        },
        cubicSubdivide: function(t, e, i, o, n, r) {
            var s = (e - t) * n + t,
                a = (i - e) * n + e,
                h = (o - i) * n + i,
                l = (a - s) * n + s,
        ...
        cubicProjectPoint: function(t, e, i, n, a, h, u, p, f, g, m) {
            var _, y = .005,
                v = 1 / 0;
            l[0] = f, l[1] = g;
            for (var x = 0; 1 > x; x += .05) c[0] = o(t, i, a, u, x), c[1] = o(e, n, h, p, x), v > (z = r.distSquare(l, c)) && (_ = x, v = z);
            v = 1 / 0;
            for (var b = 0; 32 > b && !(s > y); b++) {
                var T = _ - y,
                    S = _ + y;
                c[0] = o(t, i, a, u, T), c[1] = o(e, n, h, p, T);
                var z = r.distSquare(c, l);
                if (T >= 0 && v > z) _ = T, v = z;
                else {
                    d[0] = o(t, i, a, u, S), d[1] = o(e, n, h, p, S);
                    var C = r.distSquare(d, l);
                    1 >= S && v > C ? (_ = S, v = C) : y *= .5
                }
            }
            return m && (m[0] = o(t, i, a, u, _), m[1] = o(e, n, h, p, _)), Math.sqrt(v)
        },
        quadraticAt: n,
        quadraticDerivativeAt: function(t, e, i, o) {
            return 2 * ((1 - o) * (e - t) + o * (i - e))
        },
        quadraticRootAt: function(t, o, n, r, s) {
            var a = t - 2 * o + n,
                h = 2 * (o - t),
                l = t - r,
                c = 0;
            if (e(a)) i(h) && (u = -l / h) >= 0 && 1 >= u && (s[c++] = u);
            else {
                var d = h * h - 4 * a * l;
                if (e(d))(u = -h / (2 * a)) >= 0 && 1 >= u && (s[c++] = u);
                else if (d > 0) {
                    var u, p = Math.sqrt(d),
                        f = (-h - p) / (2 * a);
                    (u = (-h + p) / (2 * a)) >= 0 && 1 >= u && (s[c++] = u), f >= 0 && 1 >= f && (s[c++] = f)
                }
            }
            return c
        },
        ...
        quadraticSubdivide: function(t, e, i, o, n) {
            var r = (e - t) * o + t,
                s = (i - e) * o + e,
                a = (s - r) * o + r;
            n[0] = t, n[1] = r, n[2] = a, n[3] = a, n[4] = s, n[5] = i
        },
        quadraticProjectPoint: function(t, e, i, o, a, h, u, p, f) {
            var g, m = .005,
                _ = 1 / 0;
            l[0] = u, l[1] = p;
            for (var y = 0; 1 > y; y += .05) c[0] = n(t, i, a, y), c[1] = n(e, o, h, y), _ > (T = r.distSquare(l, c)) && (g = y, _ = T);
            _ = 1 / 0;
            for (var v = 0; 32 > v && !(s > m); v++) {
                var x = g - m,
                    b = g + m;
                c[0] = n(t, i, a, x), c[1] = n(e, o, h, x);
                var T = r.distSquare(c, l);
                if (x >= 0 && _ > T) g = x, _ = T;
                else {
                    d[0] = n(t, i, a, b), d[1] = n(e, o, h, b);
                    var S = r.distSquare(d, l);
                    1 >= b && _ > S ? (g = b, _ = S) : m *= .5
                }
            }
            return f && (f[0] = n(t, i, a, g), f[1] = n(e, o, h, g)), Math.sqrt(_)
        }
    }
    ...
    var o, n = t("../tool/matrix"),
        r = t("../tool/vector"),
        s = [0, 0],
        a = n.translate,
        h = 5e-5,
        l = function() {
            this.position || (this.position = [0, 0]), void 0 === this.rotation && (this.rotation = [0, 0, 0]), this.scale || (this.scale = [1, 1, 0, 0]), this.needLocalTransform = !1, this.needTransform = !1
        };
    return l.prototype = {
        constructor: l,
        ...
        updateTransform: function() {
            ...
            if (this.needTransform = this.needLocalTransform || t, this.needTransform) {
                ...
                if (n.identity(e), this.needLocalTransform) {
                    var o, r = this.scale;
                    if (i(r[0]) || i(r[1])) s[0] = -r[2] || 0, s[1] = -r[3] || 0, (o = i(s[0]) || i(s[1])) && a(e, e, s), n.scale(e, e, r), o && (s[0] = -s[0], s[1] = -s[1], a(e, e, s));
                    if (this.rotation instanceof Array) {
                        if (0 !== this.rotation[0]) s[0] = -this.rotation[1] || 0, s[1] = -this.rotation[2] || 0, (o = i(s[0]) || i(s[1])) && a(e, e, s), n.rotate(e, e, this.rotation[0]), o && (s[0] = -s[0], s[1] = -s[1], a(e, e, s))
                    } else 0 !== this.rotation && n.rotate(e, e, this.rotation);
                    (i(this.position[0]) || i(this.position[1])) && a(e, e, this.position)
                }
        ...
        lookAt: (o = r.create(), function(t) {
            this.transform || (this.transform = n.create());
            var i = this.transform;
            if (r.sub(o, t, this.position), !e(o[0]) || !e(o[1])) {
                r.normalize(o, o);
                var s = this.scale;
                i[2] = o[0] * s[1], i[3] = o[1] * s[1], i[0] = o[1] * s[0], i[1] = -o[0] * s[0], i[4] = this.position[0], i[5] = this.position[1], this.decomposeTransform()
            }
        }),
        ...
        transformCoordToLocal: function(t, e) {
            var i = [t, e];
            return this.needTransform && this.invTransform && r.applyTransform(i, i, this.invTransform), i
        }
    }, l
    ...
    return e.prototype = {
        ...
        restart: function() {
            var t = ((new Date).getTime() - this._startTime) % this._life;
    ...
    var t = {
        ...
        ElasticInOut: function(t) {
            var e, i = .1;
            return 0 === t ? 0 : 1 === t ? 1 : (!i || 1 > i ? (i = 1, e = .1) : e = .4 * Math.asin(1 / i) / (2 * Math.PI), (t *= 2) < 1 ? -.5 * i * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t - e) * Math.PI / .4) : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(2 * (t - e) * Math.PI / .4) * .5 + 1)
        },
        BackIn: function(t) {
    ...
    return i.prototype = {
        ...
        _mapData: function(t) {
            for (var e, i, o, n, r = this.series, s = 0, a = {}, h = this.component.legend, c = [], d = 0, u = 0, p = t.length; p > u; u++) {
                if (o = (e = r[t[u]]).name, this._sIndex2ShapeMap[t[u]] = this._sIndex2ShapeMap[t[u]] || this.query(e, "symbol") || this._symbol[u % this._symbol.length], h) {
                    if (this.selectedMap[o] = h.isSelected(o), this._sIndex2ColorMap[t[u]] = h.getColor(o), n = h.getItemShape(o)) {
                        var f = n.style;
                        if (this.type == l.CHART_TYPE_LINE) f.iconType = "legendLineIcon", f.symbol = this._sIndex2ShapeMap[t[u]];
                            ...
                            var g = n.highlightStyle;
                            f.brushType = "both", f.x += 1, f.y += 1, f.width -= 2, f.height -= 2, f.strokeColor = g.strokeColor = e.itemStyle.normal.barBorderColor, g.lineWidth = 3
                        }
                        h.setItemShape(o, n)
                    }
                } else this.selectedMap[o] = !0, this._sIndex2ColorMap[t[u]] = this.zr.getColor(t[u]);
                this.selectedMap[o] && (null == a[i = e.stack || "__kener__stack__" + t[u]] ? (a[i] = s, c[s] = [t[u]], s++) : c[a[i]].push(t[u])), d = Math.max(d, e.data.length)
            }
            return {
                locationMap: c,
                maxDataLength: d
        ...
        _calculMarkMapXY: function(t, e, i) {
            for (var o = this.series, n = 0, r = e.length; r > n; n++)
                for (var s = 0, a = e[n].length; a > s; s++) {
                    var h = e[n][s],
                        l = "xy" == i ? 0 : "",
        ...
        _buildMarkPoint: function(t) {
            ...
            if (this.type === l.CHART_TYPE_FORCE || this.type === l.CHART_TYPE_CHORD)
                for (s = 0, a = h.length; a > s; s++) this.zr.addShape(h[s])
        },
        _buildMarkLine: function(t) {
            ...
            if (n.large) {
                var d = new h({
                    ...
                    u = c[0];
                if (u) {
                    m.merge(d.style, u.style), m.merge(d.highlightStyle = {}, u.highlightStyle), d.style.brushType = "stroke", d.zlevel = o.zlevel, d.z = o.z + 1, d.hoverable = !1;
                    for (var p in i) d[p] = m.clone(i[p])
                }
                this.shapeList.push(d), this.zr.addShape(d), d._mark = "largeLine";
                var f = n.effect;
                f.show && (d.effect = f)
            } else {
                for (r = 0, s = c.length; s > r; r++) {
                    var g = c[r];
                    g.zlevel = o.zlevel, g.z = o.z + 1;
                    for (var p in i) g[p] = m.clone(i[p]);
                    this.shapeList.push(g)
                }
                if (this.type === l.CHART_TYPE_FORCE || this.type === l.CHART_TYPE_CHORD)
                    for (r = 0, s = c.length; s > r; r++) this.zr.addShape(c[r])
            }
        },
        ...
        _markLine: function() {
            ...
            return function(i, o) {
                ...
                for (var d = o.data, u = [], p = this.zr.getWidth(), f = this.zr.getHeight(), _ = 0; _ < d.length; _++) {
                    if (e((L = d[_])[0]) && e(L[1])) {
                        var y = this.deepMerge(L),
                            v = [y, o],
                            x = h,
                            b = null != y.value ? y.value : "";
                        if (s) {
                            x = isNaN(b) ? x : s.getColor(b);
                            var T = this.deepQuery(v, "itemStyle.normal.color") || x,
                                S = this.deepQuery(v, "itemStyle.emphasis.color") || T;
                            if (null == T && null == S) continue
                        }
                        L[0].tooltip = y.tooltip || o.tooltip || {
                            trigger: "item"
                        }, L[0].name = L[0].name || "", L[1].name = L[1].name || "", L[0].value = b, u.push({
                            points: [
                                [this.parsePercent(L[0].x, p), this.parsePercent(L[0].y, f)],
                                [this.parsePercent(L[1].x, p), this.parsePercent(L[1].y, f)]
                            ],
                            rawData: L,
                            color: x
                        })
                ...
                var z = this.query(o, "bundling.enable");
                if (z) {
                    var C = new g;
                    C.maxTurningAngle = this.query(o, "bundling.maxTurningAngle") / 180 * Math.PI, u = C.run(u)
                }
                o.name = n.name;
                for (var E = [], w = (_ = 0, u.length); w > _; _++) {
                    var L, A = u[_],
                        M = A.rawEdge || A,
                        k = (b = null != (L = M.rawData).value ? L.value : "", this.getMarkLineShape(o, i, L, _, A.points, z, M.color));
                    k._mark = "line";
                    var O = this.deepMerge([L[0], L[1], o], "effect");
                    O.show && (k.effect = O, k.effect.large = o.large), n.type === l.CHART_TYPE_MAP && (k._geo = [this.getMarkGeo(L[0]), this.getMarkGeo(L[1])]), c.pack(k, n, i, L[0], _, L[0].name + ("" !== L[1].name ? " > " + L[1].name : ""), b), E.push(k)
                }
                return E
            }
        }(),
        ...
        getMarkLineShape: function(t, e, i, o, n, s, h) {
            ...
            var T = new(s ? a : r)({
                ...
                S = T.style;
            return s ? (S.pointList = n, S.smooth = b) : (S.xStart = n[0][0], S.yStart = n[0][1], S.xEnd = n[1][0], S.yEnd = n[1][1], S.curveness = b, T.updatePoints(T.style)), this.addLabel(T, t, i[0], i[0].name + " : " + i[1].name)
        },
        getLargeMarkPointShape: function(t, e) {
            var i, o, n, r, a, h, l = this.series[t],
                c = this.component,
                d = e.data,
                u = c.dataRange,
                p = c.legend,
        ...
        addShapeList: function() {
            ...
            if (this.option.animation && !this.option.renderAsImage && n.length < i && !this.motionlessOnce) {
                ...
                for (d = 0, u = n.length; u > d; d++) e = this._getAnimationKey(n[d]), e.match("undefined") ? this.zr.addShape(n[d]) : (e += n[d].type, c[e] = n[d]);
                ...
                for (d = 0, u = n.length; u > d; d++) this.zr.addShape(n[d])
            }
        },
        ...
        animationMark: function(t, e, i) {
            for (var o = 0, n = (i = i || this.shapeList).length; n > o; o++) i[o]._mark && this._animateMod(!1, i[o], t, e, 0, !0);
            this.animationEffect(i)
        },
        animationEffect: function(t) {
            if (!t && this.clearEffectShape(), null != (t = t || this.shapeList)) {
        ...
        delMark: function(t, e, i) {
            ...
            var o = this.series[t];
            if (this.selectedMap[o.name]) {
                for (var n = !1, r = [this.shapeList, this.effectList], s = 2; s--;)
    ...
    function t(t, e) {
        ...
        var n = Math.pow(10, Math.max(i, o));
    ...
    var i = t("zrender/tool/util"),
        o = t("zrender/shape/Base");
    return e.prototype = {
        type: "icon",
        iconLibrary: {
            mark: function(t, e) {
            ...
            forceChart: function(t, e) {
                var i = e.x,
                    o = e.y,
                    n = e.width / 16,
                    r = e.height / 16,
                    s = 2 * Math.min(n, r);
                t.moveTo(i + n + s, o + r + s), t.arc(i + n, o + r, s, Math.PI / 4, 3 * Math.PI), t.lineTo(i + 7 * n - s, o + 6 * r - s), t.arc(i + 7 * n, o + 6 * r, s, Math.PI / 4 * 5, 4 * Math.PI), t.arc(i + 7 * n, o + 6 * r, s / 2, Math.PI / 4 * 5, 4 * Math.PI), t.moveTo(i + 7 * n - s / 2, o + 6 * r + s), t.lineTo(i + n + s, o + 14 * r - s), t.arc(i + n, o + 14 * r, s, -Math.PI / 4, 2 * Math.PI), t.moveTo(i + 7 * n + s / 2, o + 6 * r), t.lineTo(i + 14 * n - s, o + 10 * r - s / 2), t.moveTo(i + 16 * n, o + 10 * r), t.arc(i + 14 * n, o + 10 * r, s, 0, 3 * Math.PI), t.lineWidth = 1.5
            },
            chordChart: function(t, e) {
                var i = e.x,
                    o = e.y,
                    n = e.width,
                    r = e.height,
            ...
            heart: function(e, i) {
                t("zrender/shape/Heart").prototype.buildPath(e, {
                    x: i.x + i.width / 2,
                    y: i.y + .2 * i.height,
                    a: i.width / 2,
                    b: .8 * i.height
            ...
            droplet: function(e, i) {
                t("zrender/shape/Droplet").prototype.buildPath(e, {
                    x: i.x + .5 * i.width,
                    y: i.y + .5 * i.height,
                    a: .5 * i.width,
                    b: .8 * i.height
        ...
        brush: function(e, i, o) {
            if ("image" === ((n = (n = i ? this.highlightStyle : this.style) || {}).iconType || this.style.iconType)) {
                t("zrender/shape/Image").prototype.brush.call(this, e, i, o)
            } else {
    ...
    var i = t("zrender/shape/Base"),
        o = t("./Icon"),
        n = new(t("zrender/shape/Line"))({}),
        r = new(t("zrender/shape/BezierCurve"))({}),
        s = t("zrender/tool/area"),
        a = t("zrender/shape/util/dashedLineTo"),
    ...
    return e.prototype = {
        ...
        buildPath: function(t, e) {
            ...
            if (t.moveTo(e.xStart, e.yStart), e.curveness > 0) {
                ...
                a(t, e.xStart, e.yStart, e.xEnd, e.yEnd, n)
            }
        },
        ...
        brushSymbol: function(t, e, i) {
            if ("none" != e.symbol[i]) {
                ...
                if (p = p / 180 * Math.PI, "arrow" == n && 0 === p)
                    if (0 === u) {
                        var f = 0 === i ? -1 : 1;
                        ...
                        var g = e.cpX1,
                            m = e.cpY1,
                            _ = l.quadraticDerivativeAt,
                            y = _(r, g, a, i),
                            v = _(s, m, h, i);
                        p = Math.PI / 2 + Math.atan2(v, y)
                    }
                t.translate(c, d), 0 !== p && t.rotate(p);
        ...
        getRect: function(t) {
            return t.curveness > 0 ? r.getRect(t) : n.getRect(t), t.__rect
        },
        isCover: function(t, e) {
            var i = this.transformCoordToLocal(t, e);
            return t = i[0], e = i[1], !!this.isCoverRect(t, e) && (this.style.curveness > 0 ? s.isInside(r, this.style, t, e) : s.isInside(n, this.style, t, e))
        }
    }, h.inherits(e, i), e
    ...
    return e.prototype = {
        ...
        buildPath: function(t, e) {
            var i = e.pointList,
                o = i.length;
            if (0 !== o)
                for (var n, r, s, a, h, l = Math.ceil(o / 1e4), c = i[0] instanceof Array, d = e.size ? e.size : 2, u = d, p = d / 2, f = 2 * Math.PI, g = 0; l > g; g++) {
                    t.beginPath(), r = (r = (n = 1e4 * g) + 1e4) > o ? o : r;
                    for (var m = n; r > m; m++)
                        if (e.random && (s = e["randomMap" + m % 20] / 100, u = d * s * s, p = u / 2), c ? (a = i[m][0], h = i[m][1]) : (a = i[m].x, h = i[m].y), 3 > u) t.rect(a - p, h - p, u, u);
                        else switch (e.iconType) {
                            case "circle":
                                t.moveTo(a, h), t.arc(a, h, p, 0, f, !0);
                                break;
                            case "diamond":
                                t.moveTo(a, h - p), t.lineTo(a + p / 3, h - p / 3), t.lineTo(a + p, h), t.lineTo(a + p / 3, h + p / 3), t.lineTo(a, h + p), t.lineTo(a - p / 3, h + p / 3), t.lineTo(a - p, h), t.lineTo(a - p / 3, h - p / 3), t.lineTo(a, h - p);
                                break;
                            default:
                                t.rect(a - p, h - p, u, u)
                        }
                    if (t.closePath(), l - 1 > g) switch (e.brushType) {
                        case "both":
            ...
            if (!(o.length < 2)) {
                ...
                if (e.smooth && "spline" !== e.smooth) {
                    ...
                    if ("dashed" == e.lineType || "dotted" == e.lineType) {
                        ...
                        t.moveTo(o[0][0], o[0][1]);
                        for (c = 1; r > c; c++) n(t, o[c - 1][0], o[c - 1][1], o[c][0], o[c][1], d)
                    }
                } else {
                    t.moveTo(o[0][0], o[0][1]);
                    for (c = 1; r > c; c++) t.lineTo(o[c][0], o[c][1])
                }
            }
        },
    ...
    return i.prototype = {
        ...
        getRect: function(t) {
            if (t.__rect) return t.__rect;
            for (var e = 1 / 0, i = -1 / 0, o = 1 / 0, n = -1 / 0, r = 0; r < t.shapeList.length; r++) {
                var s = t.shapeList[r],
                    a = s.getRect(s.style);
                e = Math.min(a.x, e), o = Math.min(a.y, o), i = Math.max(a.x + a.width, i), n = Math.max(a.y + a.height, n)
            }
            return t.__rect = {
                x: e,
                y: o,
        ...
        isCover: function(t, e) {
            ...
            if (t = i[0], e = i[1], this.isCoverRect(t, e))
                for (var o = 0; o < this.style.shapeList.length; o++) {
                    if (this.style.shapeList[o].isCover(t, e)) return !0
                }
            return !1
        }
    }, t("../tool/util").inherits(i, e), i
    ...
    function i(t, i, o, n, r) {
        ...
        var a = s.x,
            ...
            l = s.width,
            c = s.height,
            d = [o.position[0], o.position[1]];
        e(o, i, "x", "y", "width", "height"), o.position = i.position, t.addShape(o), (d[0] != i.position[0] || d[1] != i.position[1]) && t.animate(o.id, "").when(n, {
            position: d
        }).start(r), o.__animating = !0, t.animate(o.id, "style").when(n, {
            x: a,
            y: h,
            width: l,
            height: c
    ...
    var o = t("zrender/tool/util"),
        n = t("zrender/tool/curve");
    return {
        pointList: function(t, e, i, n, r) {
            var s, a = i.style.pointList,
                h = a.length;
            if (!e) {
                if (s = [], "vertical" != i._orient)
                    for (var l = a[0][1], c = 0; h > c; c++) s[c] = [a[c][0], l];
                else {
                    var d = a[0][0];
                    for (c = 0; h > c; c++) s[c] = [d, a[c][1]]
                }
                "half-smooth-polygon" == i.type && (s[h - 1] = o.clone(a[h - 1]), s[h - 2] = o.clone(a[h - 2])), e = {
                    style: {
                        pointList: s
                    }
                }
            }
            var u = (s = e.style.pointList).length;
            i.style.pointList = u == h ? s : h > u ? s.concat(a.slice(u)) : s.slice(0, h), t.addShape(i), i.__animating = !0, t.animate(i.id, "style").when(n, {
                pointList: a
            }).during(function() {
        ...
        sector: function(t, i, o, n, r) {
            i || (i = "r" != o._animationAdd ? {
                style: {
            ...
            var s = o.style.startAngle,
                a = o.style.endAngle;
            e(o, i, "startAngle", "endAngle"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                startAngle: s,
                endAngle: a
            }).done(function() {
                o.__animating = !1
        ...
        text: function(t, i, o, n, r) {
            ...
            var s = o.style.x,
                a = o.style.y;
            e(o, i, "x", "y"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                x: s,
                y: a
            }).done(function() {
                o.__animating = !1
        ...
        polygon: function(e, i, o, n, r) {
            var s = t("zrender/shape/Polygon").prototype.getRect(o.style),
                a = s.x + s.width / 2,
                h = s.y + s.height / 2;
        ...
        ribbon: function(t, i, o, n, r) {
            ...
            var s = o.style.source0,
                a = o.style.source1,
                h = o.style.target0,
                l = o.style.target1;
            i.style && e(o, i, "source0", "source1", "target0", "target1"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                source0: s,
                source1: a,
                target0: h,
                target1: l
        ...
        gaugePointer: function(t, e, i, o, n) {
            e || (e = {
                style: {
        ...
        icon: function(t, e, o, n, r, s) {
            if (o.style._x = o.style.x, o.style._y = o.style.y, o.style._width = o.style.width, o.style._height = o.style.height, e) i(t, e, o, n, r);
            else {
                var a = o._x || 0,
                    h = o._y || 0;
                o.scale = [.01, .01, a, h], t.addShape(o), o.__animating = !0, t.animate(o.id, "").delay(s).when(n, {
                    scale: [1, 1, a, h]
                }).done(function() {
                    o.__animating = !1
                }).start(r || "QuinticOut")
        ...
        line: function(t, i, o, n, r) {
            ...
            var s = o.style.xStart,
                a = o.style.xEnd,
                h = o.style.yStart,
                l = o.style.yEnd;
            e(o, i, "xStart", "xEnd", "yStart", "yEnd"), t.addShape(o), o.__animating = !0, t.animate(o.id, "style").when(n, {
                xStart: s,
                xEnd: a,
                yStart: h,
                yEnd: l
        ...
        markline: function(t, e, i, o, r) {
            r = r || "QuinticOut", i.__animating = !0, t.addShape(i);
            var s = i.style,
                a = function() {
                    i.__animating = !1
                },
            ...
            if (s.curveness > 0) {
                ...
                var u = {
                    ...
                    g = [],
                    m = [],
                    _ = n.quadraticSubdivide;
                t.animation.animate(u).when(o, {
                    p: 1
                }).during(function() {
                    _(h, p, c, u.p, g), _(l, f, d, u.p, m), s.cpX1 = g[1], s.cpY1 = m[1], s.xEnd = g[2], s.yEnd = m[2], t.modShape(i)
                }).done(a).start(r)
    ...
    function e(t, e, n, s, a) {
        var h = n.effect,
            u = n.style,
            p = h.color || u.strokeColor || u.color,
            f = h.shadowColor || u.strokeColor || p,
            g = u.lineWidth * h.scaleSize,
            m = void 0 !== h.shadowBlur ? h.shadowBlur : g,
            _ = new o({
                zlevel: s,
                style: {
                    x: m,
        ...
        if (d && !a) {
            s = _.zlevel;
            (_ = t.shapeToImage(_, 2 * (g + m), 2 * (g + m))).zlevel = s, _.hoverable = !1, y = m
        }
        a || (i.clone(n, _), _.position = n.position, e.push(_), t.addShape(_));
        var v = function() {
            a || (n.effect.show = !1, t.delShape(_.id)), _.effectAnimator = null
        };
        if (n instanceof l) {
            for (var x = [0], b = 0, T = u.pointList, S = u.controlPointList, z = 1; z < T.length; z++) {
                if (S) {
                    var C = S[2 * (z - 1)],
                        E = S[2 * (z - 1) + 1];
                    b += c.dist(T[z - 1], C) + c.dist(C, E) + c.dist(E, T[z])
                } else b += c.dist(T[z - 1], T[z]);
                x.push(b)
            }
            var w = {
                    p: 0
            ...
            for (z = 0; z < x.length; z++) L.when(x[z] * h.period, {
                p: z
            });
            L.during(function() {
                var e, i, o = Math.floor(w.p);
                if (o == T.length - 1) e = T[o][0], i = T[o][1];
                else {
                    var n = w.p - o,
                        s = T[o],
                        h = T[o + 1];
                    if (S) {
                        var l = S[2 * o],
                            c = S[2 * o + 1];
                        e = r.cubicAt(s[0], l[0], c[0], h[0], n), i = r.cubicAt(s[1], l[1], c[1], h[1], n)
                    } else e = (h[0] - s[0]) * n + s[0], i = (h[1] - s[1]) * n + s[1]
                }
                _.style.x = e, _.style.y = i, a || t.modShape(_)
            }).done(v).start(), L.duration = b * h.period, _.effectAnimator = L
        } else {
            var A = u.xStart - y,
                M = u.yStart - y,
                k = u.xEnd - y,
            ...
            var P = (k - A) * (k - A) + (O - M) * (O - M),
                I = Math.round(Math.sqrt(Math.round(P * h.period * h.period)));
            if (n.style.curveness > 0) {
                ...
                _.effectAnimator = t.animation.animate(_, {
                    ...
                    _.style.x = r.quadraticAt(A, D, k, i), _.style.y = r.quadraticAt(M, R, O, i), a || t.modShape(_)
                }).done(v).start()
    ...
    var i = t("../util/ecData"),
        o = t("zrender/shape/Circle"),
        n = t("zrender/shape/Image"),
        r = t("zrender/tool/curve"),
        s = t("../util/shape/Icon"),
        a = t("../util/shape/Symbol"),
        h = t("zrender/shape/ShapeBundle"),
        l = t("zrender/shape/Polyline"),
        c = t("zrender/tool/vector"),
        d = t("zrender/tool/env").canvasSupported;
    return {
        point: function(t, e, o, r) {
            var a, h = o.effect,
                l = h.color || o.style.strokeColor || o.style.color,
                c = h.shadowColor || l,
                u = h.scaleSize,
                p = h.bounceDistance,
                f = void 0 !== h.shadowBlur ? h.shadowBlur : u;
            "image" !== o.type ? (a = new s({
                zlevel: r,
                style: {
                    brushType: "stroke",
                    iconType: "droplet" != o.style.iconType ? o.style.iconType : "circle",
                    x: f + 1,
                    y: f + 1,
                    n: o.style.n,
                    width: o.style._width * u,
                    height: o.style._height * u,
                    lineWidth: 1,
                    strokeColor: l,
                    shadowColor: c,
                    shadowBlur: f
                ...
                draggable: !1,
                hoverable: !1
            }), "pin" == o.style.iconType && (a.style.y += a.style.height / 2 * 1.5), d && (a.style.image = t.shapeToImage(a, a.style.width + 2 * f + 2, a.style.height + 2 * f + 2).style.image, a = new n({
                zlevel: a.zlevel,
                style: a.style,
                draggable: !1,
                hoverable: !1
                ...
                draggable: !1,
                hoverable: !1
            }), i.clone(o, a), a.position = o.position, e.push(a), t.addShape(a);
            var g = "image" !== o.type && window.devicePixelRatio || 1,
                m = (a.style.width / g - o.style._width) / 2;
            a.style.x = o.style._x - m, a.style.y = o.style._y - m, "pin" == o.style.iconType && (a.style.y -= o.style.height / 2 * 1.5);
            var _ = 100 * (h.period + 10 * Math.random());
            t.modShape(o.id, {
                invisible: !0
            });
            var y = a.style.x + a.style.width / 2 / g,
                v = a.style.y + a.style.height / 2 / g;
            "scale" === h.type ? (t.modShape(a.id, {
                scale: [.1, .1, y, v]
            }), t.animate(a.id, "", h.loop).when(_, {
                scale: [1, 1, y, v]
            }).done(function() {
                o.effect.show = !1, t.delShape(a.id)
            }).start()) : t.animate(a.id, "style", h.loop).when(_, {
                y: a.style.y - p
            }).when(2 * _, {
                y: a.style.y
            }).done(function() {
        ...
        largePoint: function(t, e, i, o) {
            var n = i.effect,
                r = n.color || i.style.strokeColor || i.style.color,
                s = n.scaleSize,
                h = n.shadowColor || r,
                l = void 0 !== n.shadowBlur ? n.shadowBlur : 2 * s,
        ...
        largeLine: function(t, i, o, n) {
            ...
            for (var l = 0, c = [], d = 0; d < s.length; d++) {
                s[d].effect = a;
                var u = e(t, null, s[d], n, !0),
                    p = u.effectAnimator;
                r.style.shapeList.push(u), p.duration > l && (l = p.duration), 0 === d && (r.style.color = u.style.color, r.style.shadowBlur = u.style.shadowBlur, r.style.shadowColor = u.style.shadowColor), c.push(p)
            }
            if (i.push(r), t.addShape(r), l) {
                r.__dummy = 0;
                var f = t.animate(r.id, "", a.loop).when(l, {
                        __dummy: 1
                    }).during(function() {
                        t.modShape(r)
                    }).done(function() {
                        o.effect.show = !1, t.delShape(r.id)
                    }).start(),
                    g = f.stop;
                f.stop = function() {
                    (function() {
    ...
    function e(t, e, n, r, s) {
        ...
        a._onlegendhoverlink = function(t) {
            if (a.legendHoverLink)
                for (var e, n = t.target, r = a.shapeList.length - 1; r >= 0; r--) e = a.type == i.CHART_TYPE_PIE || a.type == i.CHART_TYPE_FUNNEL ? o.get(a.shapeList[r], "name") : (o.get(a.shapeList[r], "series") || {}).name, e != n || a.shapeList[r].invisible || a.shapeList[r].__animating || a.zr.addHoverShape(a.shapeList[r])
    ...
    return e.prototype = {
        ...
        _getZ: function(t) {
            ...
            return e && null != e[t] ? e[t] : (e = i[this.type]) && null != e[t] ? e[t] : 0
        },
        ...
        subPixelOptimize: function(t, e) {
            return e % 2 == 1 ? Math.floor(t) + .5 : Math.round(t)
        },
        resize: function() {
    ...
    function o(t) {
        var e = t.points;
        e[0][1] < e[1][1] || t instanceof i ? (this.array = [e[0][0], e[0][1], e[1][0], e[1][1]], this._startPoint = e[0], this._endPoint = e[1]) : (this.array = [e[1][0], e[1][1], e[0][0], e[0][1]], this._startPoint = e[1], this._endPoint = e[0]), this.ink = y(e[0], e[1]), this.edge = t, this.group = null
    }

    function n() {
        this.edgeList = [], this.mp0 = m(), this.mp1 = m(), this.ink = 0
    }

    function r() {
        this.maxNearestEdge = 6, this.maxTurningAngle = Math.PI / 4, this.maxIteration = 20
    }
    var s, a, h, l, c, d, u, p, f = t("../data/KDTree"),
        g = t("zrender/tool/vector"),
        m = g.create,
        _ = g.distSquare,
        y = g.dist,
        v = g.copy,
    ...
    return o.prototype.getStartPoint = function() {
        ...
        run: function(t) {
            ...
            function o(t, i) {
                for (var o = [], n = 0, r = 0; r < t.length; r++) n > 0 && e(t[r], o[n - 1]) || (o[n++] = x(t[r]));
                ...
                c = function(t, e) {
                    for (var n, r = 0; r < t.length; r++) {
                        ...
                        if (s.edgeList[0] && s.edgeList[0].edge instanceof i) {
                            ...
                            (n = e ? e.slice() : []).unshift(s.mp0), n.push(s.mp1), c(a, n)
                        } else
                            for (h = 0; h < s.edgeList.length; h++) {
                                var d = s.edgeList[h];
                                (n = e ? e.slice() : []).unshift(s.mp0), n.push(s.mp1), n.unshift(d.getStartPoint()), n.push(d.getEndPoint()), l.push({
                                    points: o(n, d.edge.points),
                                    rawEdge: d.edge
                                })
                            }
                    }
        ...
        _iterate: function(t) {
            for (var i = [], r = [], s = 0, a = 0; a < t.length; a++) {
                var h = new o(t[a]);
                i.push(h)
            }
            var l = new f(i, 4),
            ...
            for (a = 0; a < i.length; a++) {
                if (!(h = i[a]).group) {
                    l.nearestN(h, this.maxNearestEdge, e, c);
                    for (var x = 0, b = null, T = null, S = 0; S < c.length; S++) {
                        var z = c[S],
                            C = 0;
                        z.group ? z.group !== T && (T = z.group, p = this._calculateGroupEdgeInk(z.group, h, d, u), C = z.group.ink + h.ink - p) : (p = this._calculateEdgeEdgeInk(h, z, d, u), C = z.ink + h.ink - p), C > x && (x = C, b = z, v(_, u), v(g, d), y = p)
                    }
                    if (b) {
                        s += x, b.group || (E = new n, r.push(E), E.addEdge(b)), E = b.group, v(E.mp0, g), v(E.mp1, _), E.ink = y, b.group.addEdge(h)
                    } else {
                        var E = new n;
                        r.push(E), v(E.mp0, h.getStartPoint()), v(E.mp1, h.getEndPoint()), E.ink = h.ink, E.addEdge(h)
                    }
                }
            }
            return {
        ...
        _calculateEdgeEdgeInk: (u = [], p = [], function(t, e, i, o) {
            return u[0] = t.getStartPoint(), u[1] = e.getStartPoint(), p[0] = t.getEndPoint(), p[1] = e.getEndPoint(), this._calculateMeetPoints(u, p, i, o), y(u[0], i) + y(i, o) + y(o, p[0]) + y(u[1], i) + y(o, p[1])
        }),
        _calculateGroupEdgeInk: function(t, e, i, o) {
            ...
            var h = y(i, o);
            for (s = 0; s < n.length; s++) h += y(n[s], i) + y(r[s], o);
            return h
        },
        _calculateMeetPoints: (c = m(), d = m(), function(t, e, i, o) {
            g.set(c, 0, 0), g.set(d, 0, 0);
            for (var n = t.length, r = 0; n > r; r++) g.add(c, c, t[r]);
            for (g.scale(c, c, 1 / n), n = e.length, r = 0; n > r; r++) g.add(d, d, e[r]);
            g.scale(d, d, 1 / n), this._limitTurningAngle(t, c, d, i), this._limitTurningAngle(e, d, c, o)
        }),
        _limitTurningAngle: (s = m(), a = m(), h = m(), l = m(), function(t, e, i, o) {
            var n = Math.cos(this.maxTurningAngle),
                r = Math.tan(this.maxTurningAngle);
            g.sub(s, e, i), g.normalize(s, s), g.copy(o, e);
            for (var c = 0, d = 0; d < t.length; d++) {
                ...
                var f = g.dot(a, s);
                if (n > f) {
                    g.scaleAndAdd(h, e, s, p * f);
                    var m = y(h, u) / r;
                    g.scaleAndAdd(l, h, s, -m);
                    var v = _(l, e);
                    v > c && (c = v, g.copy(o, l))
                }
            }
    ...
    return s.prototype = {
        ...
        buildPath: function(t, e) {
            ...
            if (r && !(2 > r)) {
                ...
                for (m = 0; m < f.length; m++) t.lineTo(f[m][0], f[m][1]);
                t.closePath()
            }
        },
        getRect: function(t) {
    ...
    return {
        sin: function(e, i) {
            return Math.sin(i ? e * t : e)
        },
        cos: function(e, i) {
            return Math.cos(i ? e * t : e)
        },
        ...
        for (var o = 0; o < this.pathCommands.length; o++) {
            ...
            switch (n.command) {
                ...
                case "C":
                    ...
                    break;
                case "Q":
                    for (s = 0; 4 > s; s += 2) t[0] = Math.min(t[0], t[0], r[s]), t[1] = Math.min(t[1], t[1], r[s + 1]), i[0] = Math.max(i[0], i[0], r[s]), i[1] = Math.max(i[1], i[1], r[s + 1]);
                    break;
                case "A":
                    var a = r[0],
                        h = r[1],
    ...
    return i.prototype = {
        type: "bezier-curve",
        buildPath: function(t, e) {
            t.moveTo(e.xStart, e.yStart), void 0 !== e.cpX2 && void 0 !== e.cpY2 ? t.bezierCurveTo(e.cpX1, e.cpY1, e.cpX2, e.cpY2, e.xEnd, e.yEnd) : t.quadraticCurveTo(e.cpX1, e.cpY1, e.xEnd, e.yEnd)
        },
        getRect: function(t) {
            if (t.__rect) return t.__rect;
            var e = Math.min(t.xStart, t.xEnd, t.cpX1),
                ...
                r = t.cpX2,
                s = t.cpY2;
            void 0 !== r && void 0 !== s && (e = Math.min(e, r), i = Math.min(i, s), o = Math.max(o, r), n = Math.max(n, s));
            var a = t.lineWidth || 1;
            return t.__rect = {
                x: e - a,
                y: i - a,
            ...
            if (!(r.length < 2)) {
                if (e.smooth && "spline" !== e.smooth) {
                    ...
                    if ("dashed" == e.lineType || "dotted" == e.lineType) {
                        ...
                        d = 1;
                        for (var p = r.length; p > d; d++) n(t, r[d - 1][0], r[d - 1][1], r[d][0], r[d][1], u);
                        n(t, r[r.length - 1][0], r[r.length - 1][1], r[0][0], r[0][1], u)
                    }
                } else {
                    t.moveTo(r[0][0], r[0][1]);
                    for (d = 1, p = r.length; p > d; d++) t.lineTo(r[d][0], r[d][1]);
    ...
    return function(t, i, o, n) {
        ...
        if (d) {
            r = [1 / 0, 1 / 0], s = [-1 / 0, -1 / 0];
            for (var u = 0, p = t.length; p > u; u++) e.min(r, r, t[u]), e.max(s, s, t[u]);
            e.min(r, r, n[0]), e.max(s, s, n[1])
        }
        for (u = 0, p = t.length; p > u; u++) {
            var f, g, m = t[u];
            if (o) f = t[u ? u - 1 : p - 1], g = t[(u + 1) % p];
            else {
                if (0 === u || u === p - 1) {
                    a.push(e.clone(t[u]));
                    continue
            ...
            e.sub(h, g, f), e.scale(h, h, i);
            var _ = e.distance(m, f),
                y = e.distance(m, g),
                v = _ + y;
            0 !== v && (_ /= v, y /= v), e.scale(l, h, -_), e.scale(c, h, y);
            var x = e.add([], m, l),
                b = e.add([], m, c);
            d && (e.max(x, x, r), e.min(x, x, s), e.max(b, b, r), e.min(b, b, s)), a.push(x), a.push(b)
        }
        return o && a.push(e.clone(a.shift())), a
    }
}), define("echarts/util/ecQuery", ["require", "zrender/tool/util"], function(t) {
    function e(t, e) {
        if (void 0 !== t) {
            if (!e) return t;
            for (var i = (e = e.split(".")).length, o = 0; i > o;) {
                if (void 0 === (t = t[e[o]])) return;
                o++
            }
            return t
        }
    ...
    return {
        query: e,
        deepQuery: function(t, i) {
            for (var o, n = 0, r = t.length; r > n; n++)
                if (o = e(t[n], i), void 0 !== o) return o
        },
        deepMerge: function(t, o) {
            for (var n, r = t.length; r--;) {
                var s = e(t[r], o);
                void 0 !== s && (void 0 === n ? n = i.clone(s) : i.merge(n, s, !0))
            }
            return n
        }
    }
    ...
    function t(t, e) {
        return "string" == typeof t ? (i = t, i.replace(/^\s+/, "").replace(/\s+$/, "")).match(/%$/) ? parseFloat(t) / 100 * e : parseFloat(t) : t;
        var i
    }
    return {
        parsePercent: t,
        parseCenter: function(e, i) {
            return [t(i[0], e.getWidth()), t(i[1], e.getHeight())]
        },
        parseRadius: function(e, i) {
            i instanceof Array || (i = [0, i]);
            var o = Math.min(e.getWidth(), e.getHeight()) / 2;
            return [t(i[0], o), t(i[1], o)]
        },
    ...
    return i.prototype._buildTree = function(t, i, o, n) {
        if (i > o) return null;
        var r = Math.floor((i + o) / 2),
            s = t[r = e(t, i, o, r, function(t, e) {
                return t.array[n] - e.array[n]
            })],
            a = new function(t, e) {
                this.left = null, this.right = null, this.axis = t, this.data = e
            }(n, s);
        return n = (n + 1) % this.dimension, o > i && (a.left = this._buildTree(t, i, r - 1, n), a.right = this._buildTree(t, r + 1, o, n)), a
    }, i.prototype.nearest = function(t, e) {
        var i = this.root,
            o = this._stack,
            n = 0,
            r = 1 / 0,
        ...
        for (i.data !== t && (r = e(i.data, t), s = i), t.array[i.axis] < i.data.array[i.axis] ? (i.right && (o[n++] = i.right), i.left && (o[n++] = i.left)) : (i.left && (o[n++] = i.left), i.right && (o[n++] = i.right)); n--;) {
            ...
            var a = t.array[i.axis] - i.data.array[i.axis],
                h = 0 > a,
                l = !1;
            r > (a *= a) && (r > (a = e(i.data, t)) && i.data !== t && (r = a, s = i), l = !0), h ? (l && i.right && (o[n++] = i.right), i.left && (o[n++] = i.left)) : (l && i.left && (o[n++] = i.left), i.right && (o[n++] = i.right))
        }
        return s.data
    }, i.prototype._addNearest = function(t, e, i) {
        for (var o = this._nearstNList, n = t - 1; n > 0 && !(e >= o[n - 1].dist); n--) o[n].dist = o[n - 1].dist, o[n].node = o[n - 1].node;
        o[n].dist = e, o[n].node = i
    }, i.prototype.nearestN = function(t, e, i, o) {
        ...
        for (n.data !== t && (c++, this._addNearest(c, l, n)), t.array[n.axis] < n.data.array[n.axis] ? (n.right && (r[s++] = n.right), n.left && (r[s++] = n.left)) : (n.left && (r[s++] = n.left), n.right && (r[s++] = n.right)); s--;) {
            n = r[s];
            var d = 0 > (l = t.array[n.axis] - n.data.array[n.axis]),
                u = !1;
        ...
        for (h = 0; c > h; h++) o[h] = a[h].node.data;
        return o.length = c, o
    }, i
    ...
    return function(i, o, n, r, s) {
        return arguments.length <= 3 && (r = o, s = 2 == arguments.length ? t : n, o = 0, n = i.length - 1),
            function(t, i, o, n, r) {
                for (var s = i; o > i;) {
                    var a = t[s = Math.round((o + i) / 2)];
                    e(t, s, o), s = i;
    ...
    return e.prototype = {
        ...
        show: function(t) {
            ...
            this._buttonClose.onclick = function() {
                o.hide()
            }, this._tDom.appendChild(this._buttonClose), !1 === this.query(this.option, "toolbox.feature.dataView.readOnly") ? (this._buttonRefresh.style.cssText = "float:right;margin-right:10px;padding:1px 6px;", this._buttonRefresh.innerHTML = e[2] || this._lang[2], this._buttonRefresh.onclick = function() {
                o._save()
        ...
        _save: function() {
            ...
            var s = this;
            setTimeout(function() {
                s.messageCenter && s.messageCenter.dispatch(o.EVENT.DATA_VIEW_CHANGED, null, {
                    option: s.option
                }, s.myChart)
        ...
        _contentToOption: function(t) {
            var e, i, n, r, s = [],
                a = 0;
            if (this.option.xAxis)
                for (s = this.option.xAxis instanceof Array ? this.option.xAxis : [this.option.xAxis], e = 0, i = s.length; i > e; e++)
                    if ("category" == (s[e].type || "category")) {
                        for (n = t[a].split(","), l = 0, c = s[e].data.length; c > l; l++) r = this._trim(n[l] || ""), s[e].data[l], void 0 !== s[e].data[l].value ? s[e].data[l].value = r : s[e].data[l] = r;
                        a++
                    }
            if (this.option.yAxis)
                for (s = this.option.yAxis instanceof Array ? this.option.yAxis : [this.option.yAxis], e = 0, i = s.length; i > e; e++)
                    if ("category" == s[e].type) {
                        for (n = t[a].split(","), l = 0, c = s[e].data.length; c > l; l++) r = this._trim(n[l] || ""), s[e].data[l], void 0 !== s[e].data[l].value ? s[e].data[l].value = r : s[e].data[l] = r;
                        a++
                    }
            var h = this.option.series;
            for (e = 0, i = h.length; i > e; e++)
                if (a++, h[e].type == o.CHART_TYPE_SCATTER)
                    for (var l = 0, c = h[e].data.length; c > l; l++) n = t[a], r = n.replace(" ", "").split(","), void 0 !== h[e].data[l].value ? h[e].data[l].value = r : h[e].data[l] = r, a++;
                else {
                    n = t[a].split(",");
                    for (l = 0, c = h[e].data.length; c > l; l++) r = (n[l] || "").replace(/.*:/, ""), r = this._trim(r), r = "-" != r && "" !== r ? r - 0 : "-", void 0 !== h[e].data[l].value ? h[e].data[l].value = r : h[e].data[l] = r;
                    a++
                }
        },
        _trim: function(t) {
    ...
    var i = t("./vector"),
        ...
        r = i.create(),
        s = i.create();
    return e.cubeBezier = function(t, e, i, n, r, s) {
        var a = [];
        o.cubicExtrema(t[0], e[0], i[0], n[0], a);
        for (var h = 0; h < a.length; h++) a[h] = o.cubicAt(t[0], e[0], i[0], n[0], a[h]);
        var l = [];
        for (o.cubicExtrema(t[1], e[1], i[1], n[1], l), h = 0; h < l.length; h++) l[h] = o.cubicAt(t[1], e[1], i[1], n[1], l[h]);
        ...
        r[0] = c, r[1] = u, s[0] = d, s[1] = p
    }, e.quadraticBezier = function(t, e, i, n, r) {
        var s = o.quadraticExtremum(t[0], e[0], i[0]),
            a = o.quadraticExtremum(t[1], e[1], i[1]),
            h = 1 - (s = Math.max(Math.min(s, 1), 0)),
            l = 1 - (a = Math.max(Math.min(a, 1), 0)),
            c = h * h * t[0] + 2 * h * s * e[0] + s * s * i[0],
            d = h * h * t[1] + 2 * h * s * e[1] + s * s * i[1],
            u = l * l * t[0] + 2 * l * a * e[0] + a * a * i[0],
            p = l * l * t[1] + 2 * l * a * e[1] + a * a * i[1];
        n[0] = Math.min(t[0], i[0], c, u), n[1] = Math.min(t[1], i[1], d, p), r[0] = Math.max(t[0], i[0], c, u), r[1] = Math.max(t[1], i[1], d, p)
    }, e.arc = function(t, e, o, a, h, l, c, d) {
        if (Math.abs(a - h) >= 2 * Math.PI) return c[0] = t - o, c[1] = e - o, d[0] = t + o, void(d[1] = e + o);
        if (n[0] = Math.cos(a) * o + t, n[1] = Math.sin(a) * o + e, r[0] = Math.cos(h) * o + t, r[1] = Math.sin(h) * o + e, i.min(c, n, r), i.max(d, n, r), 0 > (a %= 2 * Math.PI) && (a += 2 * Math.PI), 0 > (h %= 2 * Math.PI) && (h += 2 * Math.PI), a > h && !l ? h += 2 * Math.PI : h > a && l && (a += 2 * Math.PI), l) {
            var u = h;
            h = a, a = u
        }
        for (var p = 0; h > p; p += Math.PI / 2) p > a && (s[0] = Math.cos(p) * o + t, s[1] = Math.sin(p) * o + e, i.min(c, s, c), i.max(d, s, d))
    }, e
    ...
    return e.prototype = {
            ...
            refixAxisShape: function(t, e) {
                if (this.option.axisLine.onZero) {
                    ...
                    if (!this.isHorizontal() && null != t)
                        for (o = 0, n = this.shapeList.length; n > o; o++) "axisLine" === this.shapeList[o]._axisShape ? (this.shapeList[o].style.xStart = this.shapeList[o].style.xEnd = this.subPixelOptimize(t, this.shapeList[o].stylelineWidth), this.zr.modShape(this.shapeList[o].id)) : "axisTick" === this.shapeList[o]._axisShape && (i = this.shapeList[o].style.xEnd - this.shapeList[o].style.xStart, this.shapeList[o].style.xStart = t, this.shapeList[o].style.xEnd = t + i, this.zr.modShape(this.shapeList[o].id))
                }
            },
        ...
        reformOption: function(t) {
            if (!t || t instanceof Array && 0 === t.length ? t = [{
                ...
                for (e = 0, i = t.length; i > e; e++) t[e].type = t[e].type || "value", t[e].xAxisIndex = -1, t[e].yAxisIndex = e
            }
            return t
        },
        refresh: function(e) {
            ...
            for (var o = t("./categoryAxis"), n = t("./valueAxis"), r = Math.max(i && i.length || 0, this._axisList.length), s = 0; r > s; s++) !this._axisList[s] || !e || i[s] && this._axisList[s].type == i[s].type || (this._axisList[s].dispose && this._axisList[s].dispose(), this._axisList[s] = !1), this._axisList[s] ? this._axisList[s].refresh && this._axisList[s].refresh(!!i && i[s], this.series) : i && i[s] && (this._axisList[s] = "category" === i[s].type ? new o(this.ecTheme, this.messageCenter, this.zr, i[s], this.myChart, this.axisBase) : new n(this.ecTheme, this.messageCenter, this.zr, i[s], this.myChart, this.axisBase, this.series))
        },
        getAxis: function(t) {
    ...
    return e.prototype = {
        ...
        _getZoom: function() {
            ...
            if (a = this.zoomOption.yAxisIndex, i && null == a) {
                n = [];
                for (h = 0, l = i.length; l > h; h++) "category" == i[h].type && n.push(h)
            ...
            for (h = 0, l = t.length; l > h; h++)
                if (c = t[h], c.type == s.CHART_TYPE_LINE || c.type == s.CHART_TYPE_BAR || c.type == s.CHART_TYPE_SCATTER || c.type == s.CHART_TYPE_K) {
                    for (var d = 0, u = o.length; u > d; d++)
                        if (o[d] == (c.xAxisIndex || 0)) {
                            r.push(h);
                            break
                        }
                    for (d = 0, u = n.length; u > d; d++)
                        if (n[d] == (c.yAxisIndex || 0)) {
                            r.push(h);
                            break
                        }
            ...
            return p > f && (p += f, p -= f = p - f), {
                start: p,
                end: f,
                start2: 0,
                end2: 100,
                size: Math.round((f - p) / 100 * ("horizontal" == this.zoomOption.orient ? this._location.width : this._location.height)),
                xAxisIndex: o,
                yAxisIndex: n,
                seriesIndex: r,
        ...
        _backupData: function() {
            ...
            var n = this.option.yAxis,
                r = this._zoom.yAxisIndex;
            for (i = 0, o = r.length; o > i; i++) this._originalData.yAxis[r[i]] = n[r[i]].data;
            var a, h = this.option.series,
                l = this._zoom.seriesIndex;
            for (i = 0, o = l.length; o > i; i++) a = h[l[i]], this._originalData.series[l[i]] = a.data, a.data && this.getDataFromOption(a.data[0]) instanceof Array && (a.type == s.CHART_TYPE_SCATTER || a.type == s.CHART_TYPE_LINE || a.type == s.CHART_TYPE_BAR) && (this._backupScale(), this._calculScatterMap(l[i]))
        },
        _calculScatterMap: function(e) {
            this._zoom.scatterMap = this._zoom.scatterMap || {}, this._zoom.scatterMap[e] = this._zoom.scatterMap[e] || {};
            var i = t("../component").get("axis"),
                o = h.clone(this.option.xAxis);
            "category" == o[0].type && (o[0].type = "value"), o[1] && "category" == o[1].type && (o[1].type = "value");
            var n = new i(this.ecTheme, null, !1, {
                    xAxis: o,
                    series: this.option.series
                }, this, "xAxis"),
                r = this.option.series[e].xAxisIndex || 0;
            this._zoom.scatterMap[e].x = n.getAxis(r).getExtremum(), n.dispose(), "category" == (o = h.clone(this.option.yAxis))[0].type && (o[0].type = "value"), o[1] && "category" == o[1].type && (o[1].type = "value"), n = new i(this.ecTheme, null, !1, {
                yAxis: o,
                series: this.option.series
            }, this, "yAxis"), r = this.option.series[e].yAxisIndex || 0, this._zoom.scatterMap[e].y = n.getAxis(r).getExtremum(), n.dispose()
        },
        _buildBackground: function() {
            ...
            var c = this._originalData.yAxis,
                d = this._zoom.yAxisIndex;
            for (h = 0, l = d.length; l > h; h++) i = Math.max(i, c[d[h]].length);
            var u, p = this._zoom.seriesIndex[0],
                f = this._originalData.series[p],
                g = Number.MIN_VALUE,
                m = Number.MAX_VALUE;
            for (h = 0, l = f.length; l > h; h++) u = this.getDataFromOption(f[h], 0), this.option.series[p].type == s.CHART_TYPE_K && (u = u[1]), isNaN(u) && (u = 0), g = Math.max(g, u), m = Math.min(m, u);
            var _ = g - m,
                y = [],
                v = t / (i - (i > 1 ? 1 : 0)),
                x = e / (i - (i > 1 ? 1 : 0)),
            ...
            for (h = 0, l = i; l > h; h += b) u = this.getDataFromOption(f[h], 0), this.option.series[p].type == s.CHART_TYPE_K && (u = u[1]), isNaN(u) && (u = 0), y.push("horizontal" == this.zoomOption.orient ? [this._location.x + v * h, this._location.y + e - 1 - Math.round((u - m) / _ * (e - 10))] : [this._location.x + 1 + Math.round((u - m) / _ * (t - 10)), this._location.y + x * (l - h - 1)]);
        ...
        _synScatterData: function(t, e) {
            ...
            var i, o, n, r, s, a, h = [],
                l = this._zoom.scatterMap[t];
            "horizontal" == this.zoomOption.orient ? (i = l.x.max - l.x.min, o = this._zoom.start / 100 * i + l.x.min, n = this._zoom.end / 100 * i + l.x.min, i = l.y.max - l.y.min, r = this._zoom.start2 / 100 * i + l.y.min, s = this._zoom.end2 / 100 * i + l.y.min) : (i = l.x.max - l.x.min, o = this._zoom.start2 / 100 * i + l.x.min, n = this._zoom.end2 / 100 * i + l.x.min, i = l.y.max - l.y.min, r = this._zoom.start / 100 * i + l.y.min, s = this._zoom.end / 100 * i + l.y.min), (a = l.x.dataMappingMethods) && (o = a.coord2Value(o), n = a.coord2Value(n)), (a = l.y.dataMappingMethods) && (r = a.coord2Value(r), s = a.coord2Value(s));
            for (var c, d = 0, u = e.length; u > d; d++) c = e[d].value || e[d], c[0] >= o && c[0] <= n && c[1] >= r && c[1] <= s && h.push(e[d]);
            return h
        },
        _setScale: function() {
    ...
    function e(t, e, o, n, r, s) {
        if (n.data.length < 1) console.error("option.data.length < 1.");
        else {
    ...
    return e.prototype = {
        ...
        _buildAxisTick: function() {
            var t, e = this.option.data,
                ...
                s = o.lineStyle.color,
                a = o.lineStyle.width,
                h = "function" == typeof o.interval ? o.interval : "auto" == o.interval && "function" == typeof this.option.axisLabel.interval && this.option.axisLabel.interval,
                l = h ? 1 : "auto" == o.interval ? this._interval : o.interval - 0 + 1,
                c = o.onGap,
                d = c ? this.getGap() / 2 : void 0 === c && this.option.boundaryGap ? this.getGap() / 2 : 0,
                u = d > 0 ? -l : 0;
            if (this.isHorizontal())
                for (var p, f = "bottom" == this.option.position ? o.inside ? this.grid.getYend() - r - 1 : this.grid.getYend() + 1 : o.inside ? this.grid.getY() + 1 : this.grid.getY() - r - 1, g = u; i > g; g += l)(!h || h(g, e[g])) && (p = this.subPixelOptimize(this.getCoordByIndex(g) + (g >= 0 ? d : 0), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                ...
                var m, _ = "left" == this.option.position ? o.inside ? this.grid.getX() + 1 : this.grid.getX() - r - 1 : o.inside ? this.grid.getXend() - r - 1 : this.grid.getXend() + 1;
                for (g = u; i > g; g += l)(!h || h(g, e[g])) && (m = this.subPixelOptimize(this.getCoordByIndex(g) - (g >= 0 ? d : 0), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
        ...
        _buildAxisLabel: function() {
            var t, e, i = this.option.data,
                ...
                l = r.clickable,
                c = r.textStyle,
                d = "function" == typeof r.interval && r.interval;
            if (this.isHorizontal()) {
                var u, p;
                ...
                for (f = 0; n > f; f += this._interval) d && !d(f, i[f]) || "" === this._getReformedLabel(f) || (e = a.merge(i[f].textStyle || {}, c), t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase() + 3,
                    hoverable: !1,
                    style: {
        ...
        _buildSplitLine: function() {
            var t, e = this.option.data,
                ...
                s = o.lineStyle.width,
                a = o.lineStyle.color,
                h = (a = a instanceof Array ? a : [a]).length,
                l = "function" == typeof this.option.axisLabel.interval && this.option.axisLabel.interval,
                c = o.onGap,
                d = c ? this.getGap() / 2 : void 0 === c && this.option.boundaryGap ? this.getGap() / 2 : 0;
            if (i -= c || void 0 === c && this.option.boundaryGap ? 1 : 0, this.isHorizontal())
                ...
                var m, _ = this.grid.getX(),
                    y = this.grid.getXend();
                for (g = 0; i > g; g += this._interval)(!l || l(g, e[g])) && (m = this.subPixelOptimize(this.getCoordByIndex(g) - d, s), t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
        ...
        _buildSplitArea: function() {
            ...
            if (o instanceof Array) {
                var n = o.length,
                    ...
                    a = "function" == typeof this.option.axisLabel.interval && this.option.axisLabel.interval,
                    h = i.onGap,
                    l = h ? this.getGap() / 2 : void 0 === h && this.option.boundaryGap ? this.getGap() / 2 : 0;
                if (this.isHorizontal())
                    for (var c, d = this.grid.getY(), u = this.grid.getHeight(), p = this.grid.getX(), f = 0; s >= f; f += this._interval) a && !a(f, e[f]) && s > f || (c = s > f ? this.getCoordByIndex(f) + l : this.grid.getXend(), t = {
                        ...
                        style: {
                            ...
                            width: c - p,
                            height: u,
                            color: o[f / this._interval % n]
                        }
                    }, this.shapeList.push(new r(t)), p = c);
                else {
                    var g, m = this.grid.getX(),
                        _ = this.grid.getWidth(),
                        y = this.grid.getYend();
                    for (f = 0; s >= f; f += this._interval) a && !a(f, e[f]) && s > f || (g = s > f ? this.getCoordByIndex(f) - l : this.grid.getY(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
        ...
        getCoord: function(t) {
            for (var e = this.option.data, i = e.length, o = this.getGap(), n = this.option.boundaryGap ? o / 2 : 0, r = 0; i > r; r++) {
                if (this.getDataFromOption(e[r]) == t) return this.isHorizontal() ? this.grid.getX() + n : this.grid.getYend() - n;
                n += o
            }
        },
        getCoordByIndex: function(t) {
            ...
            return i += t * e, this.isHorizontal() ? this.grid.getX() + i : this.grid.getYend() - i
        },
    ...
    function e(t, e, o, n, r, s, a) {
        if (a && 0 !== a.length) {
            ...
            this.refresh(n, a)
        } else console.err("option.series.length == 0.")
    }
    var i = t("./base"),
        o = t("zrender/shape/Text"),
        n = t("zrender/shape/Line"),
    ...
    return e.prototype = {
        ...
        _buildAxisTick: function() {
            var t, e = this._valueList,
                ...
                a = o.lineStyle.width;
            if (this.isHorizontal())
                for (var h, l = "bottom" === this.option.position ? o.inside ? this.grid.getYend() - r - 1 : this.grid.getYend() + 1 : o.inside ? this.grid.getY() + 1 : this.grid.getY() - r - 1, c = 0; i > c; c++) h = this.subPixelOptimize(this.getCoord(e[c]), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                ...
                var d, u = "left" === this.option.position ? o.inside ? this.grid.getX() + 1 : this.grid.getX() - r - 1 : o.inside ? this.grid.getXend() - r - 1 : this.grid.getXend() + 1;
                for (c = 0; i > c; c++) d = this.subPixelOptimize(this.getCoord(e[c]), a), t = {
                    _axisShape: "axisTick",
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
        ...
        _buildSplitLine: function() {
            ...
            if (this.isHorizontal())
                ...
                var p, f = this.grid.getX(),
                    g = this.grid.getXend();
                for (u = 0; i > u; u++) p = this.subPixelOptimize(this.getCoord(e[u]), s), t = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {
        ...
        _buildSplitArea: function() {
            ...
            if (e instanceof Array) {
                ...
                if (this.isHorizontal())
                    for (var s, a = this.grid.getY(), h = this.grid.getHeight(), l = this.grid.getX(), c = 0; n >= c; c++) s = n > c ? this.getCoord(o[c]) : this.grid.getXend(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
                    ...
                    var d, u = this.grid.getX(),
                        p = this.grid.getWidth(),
                        f = this.grid.getYend();
                    for (c = 0; n >= c; c++) d = n > c ? this.getCoord(o[c]) : this.grid.getY(), t = {
                        zlevel: this.getZlevelBase(),
                        z: this.getZBase(),
                        hoverable: !1,
                        style: {
        ...
        _calculateValue: function() {
            if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
                ...
                var a;
                for (var n in i) {
                    for (var h = 0, l = (a = i[n]).length; l > h; h++)
                        if (!isNaN(a[h])) {
                ...
                for (var n in i)
                    for (h = 0, l = (a = i[n]).length; l > h; h++) isNaN(a[h]) || (this._min = Math.min(this._min, a[h]), this._max = Math.max(this._max, a[h]));
        ...
        _calculSum: function(t, e) {
            ...
            if (this.series[e].stack) {
                ...
                t[r] = t[r] || [], t[h] = t[h] || [], t[n] = t[n] || [];
                for (var l = 0, c = (o = this.series[e].data).length; c > l; l++) i = this.getDataFromOption(o[l]), "-" !== i && (i -= 0, i >= 0 ? null != t[r][l] ? t[r][l] += i : t[r][l] = i : null != t[h][l] ? t[h][l] += i : t[h][l] = i, this.option.scale && t[n].push(i))
            } else if (t[n] = t[n] || [], this.series[e].type != s.CHART_TYPE_EVENTRIVER)
                for (l = 0, c = (o = this.series[e].data).length; c > l; l++) i = this.getDataFromOption(o[l]), this.series[e].type === s.CHART_TYPE_K ? (t[n].push(i[0]), t[n].push(i[1]), t[n].push(i[2]), t[n].push(i[3])) : i instanceof Array ? (-1 != this.option.xAxisIndex && t[n].push("time" != this.option.type ? i[0] : a.getNewDate(i[0])), -1 != this.option.yAxisIndex && t[n].push("time" != this.option.type ? i[1] : a.getNewDate(i[1]))) : t[n].push(i);
            else
                for (l = 0, c = (o = this.series[e].data).length; c > l; l++)
                    for (var d = o[l].evolution, u = 0, p = d.length; p > u; u++) t[n].push(a.getNewDate(d[u].time))
        },
        ...
        _reformTimeValue: function() {
            var t, e, i = null != this.option.splitNumber ? this.option.splitNumber : 5,
                o = a.getAutoFormatter(this._min, this._max, i),
                n = o.formatter,
                r = o.gapValue;
            switch (this._valueList = [a.getNewDate(this._min)], n) {
                case "week":
                    t = a.nextMonday(this._min);
                    break;
                case "month":
                    t = a.nextNthOnMonth(this._min, 1);
                    break;
                case "quarter":
                    t = a.nextNthOnQuarterYear(this._min, 1);
                    break;
                case "half-year":
                    t = a.nextNthOnHalfYear(this._min, 1);
                    break;
                case "year":
                    t = a.nextNthOnYear(this._min, 1);
                    break;
                default:
                    72e5 >= r ? t = (Math.floor(this._min / r) + 1) * r : ((t = a.getNewDate(this._min - -r)).setHours(6 * Math.round(t.getHours() / 6)), t.setMinutes(0), t.setSeconds(0))
            }
            for (t - this._min < r / 2 && (t -= -r), o = a.getNewDate(t), i *= 1.5; i-- >= 0 && (("month" == n || "quarter" == n || "half-year" == n || "year" == n) && o.setDate(1), !(this._max - o < r / 2));) this._valueList.push(o), o = a.getNewDate(o - -r);
            this._valueList.push(a.getNewDate(this._max)), this._reformLabelData((e = n, function(t) {
                return a.format(e, t)
            }))
        },
        ...
        _reformLabelData: function(t) {
            ...
            if (e)
                ...
                for (i = 0, o = this._valueList.length; o > i; i++) this._valueLabel.push(t ? t(this._valueList[i]) : this.numAddCommas(this._valueList[i]))
        },
        ...
        getCoord: function(t) {
            return this._dataMappingMethods && (t = this._dataMappingMethods.value2Coord(t)), t = (t = t < this._min ? this._min : t) > this._max ? this._max : t, this.isHorizontal() ? this.grid.getX() + (t - this._min) / (this._max - this._min) * this.grid.getWidth() : this.grid.getYend() - (t - this._min) / (this._max - this._min) * this.grid.getHeight()
        },
        ...
        getValueFromCoord: function(t) {
            var e;
            return this.isHorizontal() ? (t = (t = t < this.grid.getX() ? this.grid.getX() : t) > this.grid.getXend() ? this.grid.getXend() : t, e = this._min + (t - this.grid.getX()) / this.grid.getWidth() * (this._max - this._min)) : (t = (t = t < this.grid.getY() ? this.grid.getY() : t) > this.grid.getYend() ? this.grid.getYend() : t, e = this._max - (t - this.grid.getY()) / this.grid.getHeight() * (this._max - this._min)), this._dataMappingMethods && (e = this._dataMappingMethods.coord2Value(e)), e.toFixed(2) - 0
        },
    ...
    function e(t, e, o) {
        return (t = i(t)).setMonth(Math.ceil((t.getMonth() + 1) / o) * o), t.setDate(e), t
    }
    ...
    return {
        getAutoFormatter: function(t, e, i) {
            i = i > 1 ? i : 2;
            for (var n, r, s, a, h = 0, l = o.length; l > h; h++)
                if (n = o[h].value, r = Math.ceil(e / n) * n - Math.floor(t / n) * n, Math.round(r / n) <= 1.2 * i) {
                    s = o[h].formatter, a = o[h].value;
                    break
                }
            return null == s && (s = "year", n = 317088e5, r = Math.ceil(e / n) * n - Math.floor(t / n) * n, a = Math.round(r / (i - 1) / n) * n), {
                formatter: s,
                gapValue: a
            }
        },
        ...
        format: function(e, o) {
            ...
            var n = i(o),
                ...
                l = n.getMinutes(),
                c = n.getSeconds();
            return (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = (e = e.replace("MM", t(s))).toLowerCase()).replace("yyyy", r)).replace("yy", r % 100)).replace("dd", t(a))).replace("d", a)).replace("hh", t(h))).replace("h", h)).replace("mm", t(l))).replace("m", l)).replace("ss", t(c))).replace("s", c)
        },
        nextMonday: function(t) {
            return (t = i(t)).setDate(t.getDate() + 8 - t.getDay()), t
        },
        nextNthPerNmonth: e,
        nextNthOnMonth: function(t, i) {
            return e(t, i, 1)
        },
        nextNthOnQuarterYear: function(t, i) {
            return e(t, i, 3)
        },
        nextNthOnHalfYear: function(t, i) {
            return e(t, i, 6)
        },
        nextNthOnYear: function(t, i) {
            return e(t, i, 12)
        }
    }
    ...
    function i(e, i, r, s) {
        ...
        var a = o((i - e) / r, -1),
            ...
            l = o(i, -1),
            p = _.min(a.e, h.e, l.e);
        0 === h.c ? p = _.min(a.e, l.e) : 0 === l.c && (p = _.min(a.e, h.e)), n(a, {
            c: 0,
            e: p
        }), n(h, a, 1), n(l, a), s += p, e = h.c;
        for (var f = ((i = l.c) - e) / r, g = t(s), m = 0, y = [], v = r + 1; v--;) y[v] = (e + f * v) * g;
        if (0 > s) {
            m = (+g).toFixed(15).split(".").pop().replace(/0+$/, "").length, f = +(f * g).toFixed(m), e = +(e * g).toFixed(m), i = +(i * g).toFixed(m);
            for (v = y.length; v--;) y[v] = y[v].toFixed(m), 0 == +y[v] && (y[v] = "0")
        } else e *= g, i *= g, f *= g;
        return u = 0, d = 0, c = 0, {
            min: e,
            max: i,
    ...
    function o(i, o, n) {
        0 > (o = y(o % 10) || 2) && (e(i) ? o = ("" + b(i)).replace(/0+$/, "").length || 1 : (o = (i = i.toFixed(15).replace(/0+$/, "")).replace(".", "").replace(/^[-0]+/, "").length, i = +i));
        var r, s = v((r = i, _.log(b(r)) / _.LN10)) - o + 1,
            a = +(i * t(-s)).toFixed(15) || 0;
        return !(a = n ? v(a) : x(a)) && (s = 0), ("" + b(a)).length > o && (s += 1, a /= 10), {
            c: a,
            e: s
        }
    }
    ...
    function n(e, i, o) {
        var n = i.e - e.e;
        n && (e.e += n, e.c *= t(-n), e.c = o ? v(e.c) : x(e.c))
    }
    ...
    function a(a, c, g) {
        var m = g || +u.slice(-1),
            ...
            T = o(a, -1, 1),
            S = o(c, -1);
        if (n(b, _), n(T, _, 1), n(S, _), g ? function(e, i, o) {
            for (var n, r, a = i.c, h = (i.c - e.c) / o - 1; a > e.c;) h = s(h + 1, d), h = h.c * t(h.e), n = h * o, r = x(i.c / h) * h, a = r - n;
            var l = e.c - a,
                c = r - i.c,
                u = l - c;
            return u > 1.1 * h && (u = y(u / h / 2) * h, a += u, r += u), e.c = a, i.c = r, h
        }(T, S, m) : m = function(e, i) {
            for (var o, n, r, a, h = [], l = u.length; l--;) o = u[l], n = s((i.c - e.c) / o, d), n = n.c * t(n.e), r = v(e.c / n) * n, a = x(i.c / n) * n, h[l] = {
                min: r,
                max: a,
                step: n,
                span: a - r
            ...
            }), h = h[0], o = h.span / h.step, e.c = h.min, i.c = h.max, 3 > o ? 2 * o : o
        }(T, S), e(a) && e(c) && a * c >= 0) {
            if (m > c - a) return h(a, c, m);
            m = function(i, o, n, r, s, a) {
                var h = s.c - r.c,
                    l = h / a * t(s.e);
                if (!e(l) && (l = v(l), o - i > (h = l * a) && (h = (l += 1) * a, !n && l * (a - 1) >= o - i && (h = l * (a -= 1))), h >= o - i)) {
                    var c = h - (o - i);
                    r.c = y(i - c / 2), s.c = y(o + c / 2), r.e = 0, s.e = 0
                }
                return a
            }(a, c, g, T, S, m)
        }
        var z = l(a, c, T.c, S.c);
        return T.c = z[0], S.c = z[1], (p || f) && function(t, e, i, n) {
            if (p) {
                var s = o(t, 4, 1);
                i.e - s.e > 6 && (s = {
                    c: 0,
                    e: i.e
                }), r(i, s), r(n, s), n.c += s.c - i.c, i.c = s.c
            } else if (f) {
                var a = o(e, 4);
                n.e - a.e > 6 && (a = {
                    c: 0,
                    e: n.e
                }), r(i, a), r(n, a), i.c += a.c - n.c, n.c = a.c
            }
        }(a, c, T, S), i(T.c, S.c, m, S.e)
    }
    ...
    return function(t, r, s, l) {
        d = (c = l || {}).steps || g, u = c.secs || m, s = y(+s || 0) % 99, t = +t || 0, r = +r || 0, p = f = 0, "min" in c && (t = +c.min || 0, p = 1), "max" in c && (r = +c.max || 0, f = 1), t > r && (r = [t, t = r][0]);
        var v = r - t;
        if (p && f) return function(t, e, r) {
            var s = r ? [r] : u,
                a = e - t;
            if (0 === a) return e = o(e, 3), r = s[0], e.c = y(e.c + r / 2), i(e.c - r, e.c, r, e.e);
            b(e / a) < 1e-6 && (e = 0), b(t / a) < 1e-6 && (t = 0);
            var h, l, c, d = [
                    [5, 10],
                    [10, 2],
                    [50, 10],
                ...
                m = o(t, -1, 1),
                _ = o(e, -1);
            n(m, g, 1), n(_, g), a = _.c - m.c, g.c = a;
            for (var v = s.length; v--;) {
                r = s[v], h = x(a / r), c = 3 * (3 + (l = h * r - a)), c += 2 * (r - s[0] + 2), r % 5 == 0 && (c -= 10);
                for (var T = d.length; T--;) h % d[T][0] == 0 && (c /= d[T][1]);
                f[v] = [r, h, l, c].join(), p[v] = {
                    secs: r,
                    step: h,
                    delta: l,
                    score: c
            ...
            }), p = p[0], m.c = y(m.c - p.delta / 2), _.c = y(_.c + p.delta / 2), i(m.c, _.c, p.secs, g.e)
        }(t, r, s);
        if ((s || 5) > v) {
            if (e(t) && e(r)) return h(t, r, s);
            if (0 === v) return function(t, e, i) {
                i = i || 5;
                var o = _.min(b(e / i), i) / 2.1;
                return p ? e = t + o : f ? t = e - o : (t -= o, e += o), a(t, e, i)
            }(t, r, s)
        }
        return a(t, r, s)
    }
    ...
    var n, r, s, a, h, l, c, d, u, p, f = t("./number"),
        g = Math,
        m = g.log,
        _ = g.pow,
        y = g.abs,
    ...
    return function(t) {
        return e(), h = t || {},
            function() {
                null == (r = h.logLabelBase) ? (s = "plain", r = 10, a = T) : (1 > (r = +r) && (r = 10), s = "exponent", a = m(r)), null == (l = h.splitNumber) && (l = E);
                var t = parseFloat(h.dataMin),
                    e = parseFloat(h.dataMax);
                isFinite(t) || isFinite(e) ? isFinite(t) ? isFinite(e) ? t > e && (e = [t, t = e][0]) : e = t : t = e : t = e = 1, null == (n = h.logPositive) && (n = e > 0 || 0 === t), d = n ? t : -e, u = n ? e : -t, C > d && (d = C), C > u && (u = C)
            }(),
            function() {
                function t() {
                    l > b && (l = b);
                    var t, e = x(i(b / l)),
                        ...
                        s = (n - E) / 2,
                        d = x(i(f - s));
                    (t = d - f) > -C && C > t && (d -= 1), c = -d * a;
                    for (var u = d; h >= u - e; u += e) p.push(_(r, u))
                }
                ...
                var h = i(m(u) / a),
                    ...
                    b = g - y,
                    E = h - f;
                "exponent" === s ? t() : w >= b && l > w ? function() {
                    for (var t = e(y, 0), i = t + 2; i > t && n(t + 1) + o(t + 1) * z < f;) t++;
                    for (var r = e(g, 0), i = r - 2; r > i && n(r - 1) + o(r - 1) * z > h;) r--;
                    c = -(n(t) * T + o(t) * S);
                    for (var s = t; r >= s; s++) {
                        var a = n(s),
                            l = o(s);
            ...
            for (var t = [], e = 0, i = p.length; i > e; e++) t[e] = (n ? 1 : -1) * p[e];
            !n && t.reverse();
            var h, l, d = (h = n, l = c, {
                    value2Coord: function(t) {
                        return null == t || isNaN(t) || !isFinite(t) ? t : (t = parseFloat(t), isFinite(t) ? h && C > t ? t = C : !h && t > -C && (t = -C) : t = C, t = y(t), (h ? 1 : -1) * (m(t) + l))
                    },
                    coord2Value: function(t) {
                        return null == t || isNaN(t) || !isFinite(t) ? t : (t = parseFloat(t), isFinite(t) || (t = C), h ? _(b, t - l) : -_(b, -t + l))
                    }
                }),
                u = d.value2Coord,
                g = u(t[0]),
                ...
                labelFormatter: function() {
                    if ("exponent" === s) {
                        ...
                        return function(i) {
                            ...
                            var n = "";
                            return 0 > i && (i = -i, n = "-"), n + t + function(t) {
                                for (var e = [], i = 0, n = (t = o(Math.round(t))).length; n > i; i++) {
                                    var r = t.charAt(i);
                                    e.push(L[r] || "")
                                }
                                return e.join("")
                    ...
                    return function(t) {
                        return isFinite(parseFloat(t)) ? f.addCommas(o(t)) : ""
                    }
                }(),
                dataMappingMethods: d
            }
        }(), e()][0]
    }
});